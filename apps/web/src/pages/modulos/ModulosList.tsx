...
export default function ModulosList() {
  ...
  const handleDuplicar = async (moduleId: string) => {
    ...
    try {
      ...
      // Damos tiempo a que el toast se vea antes de navegar.
      window.setTimeout(() => {
        ...
        <section className="space-y-6">
          ...
          >
            {[
              ...
              { key: "public", label: "Públicos", icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
            ].map((tab) => (
              <button
                key={tab.key}
                type="button"
                      ...
                      <div className="flex flex-wrap gap-2 text-sm font-semibold">
                        ...
                        {canEdit && (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-200 px-4 py-2 text-emerald-700 transition-all duration-200 hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-800 hover:shadow-sm disabled:cursor-not-allowed disabled:opacity-50"
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
