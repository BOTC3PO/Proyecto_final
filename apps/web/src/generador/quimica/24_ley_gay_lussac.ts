...
import catalogoRaw from "../../../../../api/src/generadores/quimica/balanceo/24_ley_gay_lussac.enunciados.json?raw";
...
function parseCatalogo(): CatalogItem[] {
  ...
  try {
    ...
    throw new Error(
      `Catálogo inválido en 24_ley_gay_lussac.enunciados.json: ${String(error)}`
    );
  }
