...
export default function PadreLayout() {
  ...
  // la web, más la jerarquía de `resolvePrimaryRole` (ADMIN > DIRECTIVO
  // > TEACHER > PARENT > ...): un STAFF+PARENT va a docente-consulta,
  // no a este shell (staff rankea más arriba). Sin PARENT ni staff,
  // fallback a alumno.
