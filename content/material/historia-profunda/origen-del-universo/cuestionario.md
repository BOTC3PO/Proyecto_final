# Historia Profunda — Origen del universo (cuestionario, 25 preguntas VBLang)

> Tema: `U2`. Ver `teoria.md` en esta misma carpeta.
>
...
> recortada a un solo blanco; `tipo: vf` con
> `opciones_explicitas: ["Verdadero","Falso"]`/`["Sí","No"]`
> innecesario — normalizado a `verdadero`/`falso` bare.

---

### 1 — La naturaleza del Big Bang
...
### 2 — ¿Existe un centro del universo?
...
### 13 — Composición química primordial
...
### 14 — El efecto Doppler astronómico
...
### 21 — El alejamiento de las galaxias
...
### 25 — El origen del tiempo: la singularidad
