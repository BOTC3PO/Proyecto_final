# Historia Profunda — Movimiento de rotación y traslación (cuestionario, 25 preguntas VBLang)

> Tema: `AS1`. Ver `teoria.md` en esta misma carpeta.
>
>
...
> una pregunta `mc` cuya `respuesta:` no coincidía textualmente con
> ninguna de las `opciones_explicitas` — corregida la opción para que
> coincida exactamente; `tipo: vf` con `respuestas_validas` listando
> varios conceptos distractores como si fueran alternativas de un
> booleano — reclasificado a `completar` con una sola respuesta
> correcta.
...
### 4 — El error de la perspectiva geocéntrica
...
### 8 — Duración del ciclo de traslación
...
### 10 — El origen de las estaciones
...
### 16 — El ciclo del día y la noche
...
### 17 — La duración de las estaciones
...
### 19 — El año bisiesto y el calendario
...
### 20 — Independencia de movimientos
...
### 22 — El cambio de estaciones (escenario)
...
### 24 — El movimiento de las sombras
...
### 25 — El cambio de constelaciones
