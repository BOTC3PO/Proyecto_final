# Idiomas — Alemán — articulos-der-die-das (cuestionario, 25 preguntas VBLang)

> Corregido a partir del borrador
> (`../../../_borradores-gemma/idiomas-extranjeros/aleman/articulos-der-die-das/cuestionario_crudo.md`):
> los 25 bloques tenían `explicacion:` cerrada con comilla simple en
> vez de doble y los ítems de `pasos:` sin comillas — corregido
> mecánicamente, sin cambiar ninguna respuesta ni explicación
> original.
