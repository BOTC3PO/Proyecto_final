# Idiomas — Alemán — negacion-nicht-kein (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/aleman/negacion-nicht-kein/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.
...
metadata:  
  ...
  tema: "negacion-nicht-kein"  
  nivel: "A1"  
  tags: ["kein", "sustantivo"]  
pasos:  
  - "Identificar el uso de 'kein' en una oración negativa."  
...
### 2 — Negación de adjetivos con „nicht“  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "adjetivo"]  
pasos:  
  - "Reconocer la posición de 'nicht' al negar adjetivos."  
...
### 3 — Uso de „kein“ con sustantivos neutros  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["kein", "sustantivo"]  
pasos:  
  - "Identificar el uso de 'kein' con sustantivos neutros."  
...
### 4 — Negación de verbos en oraciones afirmativas  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' correctamente en oraciones negativas con verbos."  
...
### 5 — Negación de adjetivos con „nicht“ en oraciones comparativas  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  nivel: "A1"  
  tags: ["nicht", "comparativo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones comparativas con adjetivos."  
...
### 6 — Uso de „kein“ con sustantivos masculinos  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["kein", "sustantivo"]  
pasos:  
  - "Identificar el uso de 'kein' con sustantivos masculinos."  
...
### 7 — Negación de oraciones con „nicht“ y verbos modales  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  nivel: "A1"  
  tags: ["nicht", "verbo-modal"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos modales."  
...
### 8 — Uso de „kein“ con sustantivos femeninos  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["kein", "sustantivo"]  
pasos:  
  - "Identificar el uso de 'kein' con sustantivos femeninos."  
...
### 9 — Negación de oraciones con „nicht“ y verbos en presente  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos en presente."  
...
### 10 — Uso de „kein“ con sustantivos plurales  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["kein", "sustantivo"]  
pasos:  
  - "Identificar el uso de 'kein' con sustantivos plurales."  
...
### 11 — Negación de oraciones con „nicht“ y verbos en pasado  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos en pasado."  
...
### 12 — Uso de „kein“ con sustantivos neutros en oraciones negativas  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
...
### 13 — Negación de oraciones con „nicht“ y verbos en futuro  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos en futuro."  
...
### 14 — Uso de „kein“ con sustantivos en oraciones negativas de posesión  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["kein", "sustantivo"]  
pasos:  
  - "Identificar el uso de 'kein' en oraciones de posesión."  
...
### 15 — Negación de oraciones con „nicht“ y verbos en imperativo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos en imperativo."  
...
### 16 — Uso de „kein“ con sustantivos en oraciones negativas de acción  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["kein", "sustantivo"]  
pasos:  
  - "Identificar el uso de 'kein' en oraciones de acción."  
...
### 17 — Negación de oraciones con „nicht“ y verbos en presente perfecto  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos en presente perfecto."  
...
### 18 — Uso de „kein“ con sustantivos en oraciones negativas de posesión  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
...
### 19 — Negación de oraciones con „nicht“ y verbos en pretérito  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos en pretérito."  
...
### 20 — Uso de „kein“ con sustantivos en oraciones negativas de posesión  
```
metadata:
  materia: "aleman"
  tema: "negacion-nicht-kein"
...
### 21 — Negación de oraciones con „nicht“ y verbos en futuro perfecto  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "negacion-nicht-kein"  
  ...
  tags: ["nicht", "verbo"]  
pasos:  
  - "Ubicar 'nicht' en oraciones con verbos en futuro perfecto."  
...
### 22 — Uso de „kein“ con sustantivos en oraciones negativas de acción  
```
metadata:
  materia: "aleman"
  tema: "negacion-nicht-kein"
  ...
  tags: ["nicht", "posicion"]
pasos:
  - "Ubicar el verbo auxiliar o modal en la oración."
  - "Colocar *nicht* después del verbo auxiliar/modal."
respuesta: "hat nicht"
opciones_explicitas:
  - "hat nicht"
  - "nicht hat"
...
### 23 — Negación de oraciones con „nicht“ y verbos en presente perfecto  
```
metadata:
  materia: "aleman"
  tema: "negacion-nicht-kein"
...
### 24 — Uso de „kein“ con sustantivos en oraciones negativas de posesión  
```
metadata:
  materia: "aleman"
  tema: "negacion-nicht-kein"
  ...
  tags: ["modal", "nicht"]
pasos:
  - "Identificar el verbo modal (*können*)."
  - "Colocar *nicht* después del verbo modal."
...
### 25 — Negación de oraciones con „nicht“ y verbos en pretérito perfecto  
```
metadata:
  materia: "aleman"
  tema: "negacion-nicht-kein"
