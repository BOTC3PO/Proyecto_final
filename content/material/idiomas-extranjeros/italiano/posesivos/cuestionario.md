# Idiomas — Italiano — posesivos (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/italiano/posesivos/cuestionario_crudo.md`)
> con una corrección de contenido: cuatro bloques carecían de `enunciado:`; se redactó una
> oración con hueco para cada uno, coherente con el sustantivo y el contexto ya indicados en su
> propia `explicacion:`.
...
metadata:  
  ...
  tags: ["mio", "singular"]  
pasos:  
  - "Identificar el posesivo que completa la oración correctamente."  
...
metadata:  
  ...
  tags: ["tuo", "singular"]  
pasos:  
  - "Seleccionar el posesivo que completa la oración correctamente."  
...
### 8 — Elegir la opción correcta (4)  
```  
metadata:  
  materia: "italiano"  
  tema: "pronomi possessivi"  
  nivel: "A2"  
  tags: ["mio", "suo", "loro"]  
pasos:  
  - "Identifica il soggetto della frase."  
  - "Determina il genere e il numero del sostantivo riferito (maschile/femminile, singolare/plurale)."  
...
### 10 — Elegir la opción correcta (5)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
  nivel: "A1"  
  tags: ["vostro", "masculino"]  
pasos:  
  - "Seleccionar el posesivo que completa la oración correctamente."  
...
### 12 — Elegir la opción correcta (6)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
...
### 14 — Elegir la opción correcta (7)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
...
### 15 — Possessivo: tavolo  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
  nivel: "A2"  
  tags: ["nostro", "masculino"]  
pasos:  
  - "Identificar el posesivo que completa la oración correctamente."  
...
### 16 — Elegir la opción correcta (8)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
...
### 18 — Elegir la opción correcta (9)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
...
### 20 — Elegir la opción correcta (10)  
```  
metadata:  
  materia: "italiano"  
  tema: "pronomi possessivi"  
  ...
  tags: ["suo", "loro"]  
pasos:  
  - "Analizza la frase per capire chi possiede l'oggetto."  
  - "Verifica il genere e il numero del sostantivo (es. 'telefonino' è maschile singolare)."  
...
tipo: completar  
enunciado: "Questo telefonino è il ___."  
respuestas_validas:  
  - "suo"  
  - "Suo"  
```  
...
metadata:  
  ...
  tags: ["mie", "loro"]  
pasos:  
  - "Osserva il verbo e i soggetti coinvolti (es. 'abbiamo' indica un gruppo plurale)."  
  - "Riconosci che il sostantivo 'chiavi' è femminile plurale."  
...
tipo: mc  
enunciado: "Queste sono le ___ chiavi."  
opciones_explicitas:
  - "mie"
  - "mia"
  - "loro"
...
### 22 — Elegir la opción correcta (11)  
```  
metadata:  
  materia: "italiano"  
  tema: "pronomi possessivi"  
  ...
  tags: ["non", "mio"]  
pasos:  
  - "Leggi la frase per capire che l'oggetto non appartiene al soggetto."  
  - "Identifica il sostantivo (es. 'casa') e il suo genere/numero (femminile singolare)."  
...
tipo: completar  
enunciado: "Questa casa non è ___."  
respuestas_validas:  
  - "mia"  
  - "Mia"  
```

### 23 — Possessivo: laptop  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
...
### 24 — Elegir la opción correcta (12)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "posesivos"  
