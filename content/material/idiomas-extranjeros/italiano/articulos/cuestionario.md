# Idiomas — Italiano — articulos (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/italiano/articulos/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.
...
metadata:  
  ...
  tema: "articoli"  
  nivel: "A1"  
  tags: ["indeterminativo", "femminile"]  
pasos:  
...
### 3 — Articolo determinativo plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A1"  
  tags: ["determinativo", "plurale"]  
pasos:  
...
### 4 — Articolo indeterminativo plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A1"  
  tags: ["indeterminativo", "plurale"]  
pasos:  
...
### 5 — Articolo partitivo  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A2"  
  tags: ["partitivo", "femminile"]  
pasos:  
...
### 6 — Articolo determinativo neutro  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A1"  
  tags: ["determinativo", "neutro"]  
pasos:  
...
### 7 — Articolo indeterminativo con vocale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A1"  
  tags: ["indeterminativo", "vocale"]  
pasos:  
...
### 8 — Articolo determinativo plurale masculino  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 9 — Articolo partitivo con sostantivo maschile  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A2"  
  tags: ["partitivo", "maschile"]  
pasos:  
...
### 10 — Articolo indeterminativo con sostantivo maschile  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A1"  
  tags: ["indeterminativo", "maschile"]  
pasos:  
  - "Identificar el género del sustantivo 'libro'."  
...
### 11 — Articolo determinativo con sostantivo femenile plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 12 — Articolo partitivo con sostantivo neutro  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A2"  
  tags: ["partitivo", "neutro"]  
pasos:  
...
### 13 — Articolo determinativo con sostantivo maschile singolare  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 14 — Articolo indeterminativo con sostantivo femenile  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 15 — Articolo determinativo con sostantivo neutro plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 16 — Articolo partitivo con sostantivo femenile plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A2"  
  tags: ["partitivo", "plurale"]  
pasos:  
  - "Identificar el género del sustantivo 'casa'."  
...
### 17 — Articolo indeterminativo con sostantivo maschile plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 18 — Articolo determinativo con sostantivo femenile singolare  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A1"  
  tags: ["determinativo", "femminile"]  
pasos:  
  - "Identificar el género del sustantivo 'mela'."  
...
### 19 — Articolo partitivo con sostantivo maschile plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 20 — Articolo determinativo con sostantivo maschile singolare  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 21 — Articolo indeterminativo con sostantivo femenile plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 22 — Articolo partitivo con sostantivo neutro plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 23 — Articolo determinativo con sostantivo maschile plurale  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
...
### 24 — Articolo indeterminativo con sostantivo neutro singolare  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "articoli"  
  nivel: "A1"  
  tags: ["indeterminativo", "neutro"]  
pasos:  
  - "Identificar el género del sustantivo 'latte'."  
...
### 25 — Articolo partitivo con sostantivo maschile singolare  
```
metadata:
  materia: "italiano"
  tema: "articoli determinativi e indeterminativi"
  nivel: "A2"
  tags: ["usare", "abitudine", "libro"]
pasos:
...
metadata:
  ...
  tags: ["mangiare", "pasta"]
pasos:
  - "Elige la opción correcta para completar la oración con el artículo adecuado."
  - "Recuerda que 'la pasta' es femenino singular y requiere el artículo determinativo."
opciones_explicitas:
  - "la"
  - "il"
  - "un"
