# Idiomas — Italiano — writing-a2 (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/italiano/writing-a2/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.

---

### 1 — Coniugare il verbo "essere"  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 3 — Articolo determinativo prima di professioni  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
  nivel: "A2"  
  tags: ["articoli", "professioni"]  
pasos:  
...
### 5 — Accordare il participio passato  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
  nivel: "A2"  
  tags: ["participio", "accordo"]  
pasos:  
...
### 6 — Preposizione contratta "da" vs. "dai"  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
  nivel: "A2"  
  tags: ["preposizioni", "contrazioni"]  
pasos:  
...
### 7 — Posizione degli avverbi  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
  nivel: "A2"  
  tags: ["avverbi", "posizione"]  
pasos:  
...
### 9 — Articolo indeterminativo prima di professioni  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 11 — Accordare il participio passato  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 12 — Preposizione per espressioni temporali  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 15 — Negazione con i verbi  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
  nivel: "A2"  
  tags: ["negazione", "verbi"]  
pasos:  
...
### 16 — Accordare il participio passato  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 17 — Preposizione contratta "di" vs. "della"  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 18 — Posizione degli aggettivi  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
  nivel: "A2"  
  tags: ["aggettivi", "posizione"]  
pasos:  
...
### 21 — Articolo determinativo con parenti  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
  nivel: "A2"  
  tags: ["articoli", "parenti"]  
pasos:  
  - "Riconoscere il tipo di articolo necessario."  
...
### 23 — Accordare il participio passato  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 24 — Preposizione contratta "a" vs. "alla"  
```
metadata:  
  materia: "italiano"  
  tema: "writing-a2"  
...
### 25 — Posizione degli avverbi  
```
metadata:
  materia: "italiano"
  tema: "articoli"
  nivel: "A2"
  tags: ["indefiniti", "sostantivo maschile"]
pasos:
