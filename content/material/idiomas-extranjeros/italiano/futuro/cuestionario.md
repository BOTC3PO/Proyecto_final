# Idiomas — Italiano — futuro (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/italiano/futuro/cuestionario_crudo.md`)
> con correcciones mecánicas y una corrección de contenido: todos los bloques tenían comillas
> dobles anidadas dentro de los ítems de `pasos:` ya entrecomillados, y `explicacion:` sin
> comillas; se corrigieron ambas. Dos bloques carecían de `enunciado:`, se redactó una oración
> para cada uno. Se corrigió además un error real: un bloque llamaba "verbo irregular" a
> "prendere", cuando en realidad su futuro es completamente regular (prenderò/prenderai/
> prenderà...), siguiendo el patrón estándar de los verbos en "-ere".

---

### 1 — Futuro con "parlare"  
```  
metadata:  
...
pasos:  
  ...
  - "Seleccionar la conjugación correcta de 'vedere' en futuro."
opciones_explicitas:  
  - "vedrete"  
  - "vediamo"  
  - "vedrà"  
...
pasos:  
  ...
  - "Seleccionar la conjugación correcta de 'finire' en futuro."
opciones_explicitas:  
  - "finirà"  
  - "finiamo"  
  - "finiscono"  
...
### 5 — Futuro con "mangiare" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
  nivel: "B1"  
  tags: ["conjugacion", "lei"]  
pasos:  
...
pasos:  
  ...
  - "Seleccionar la conjugación correcta de 'dire' en futuro."
opciones_explicitas:  
  - "dirai"  
  - "dico"  
  - "dice"  
...
### 7 — Futuro con "dormire" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
pasos:  
  - "Identificar el sujeto 'io.'"
  - "Seleccionar la conjugación correcta de 'sapere' en futuro."
opciones_explicitas:  
  - "saprò"  
  - "so"  
  - "sa"  
...
### 10 — Futuro con "correre" (opciones)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
pasos:  
  - "Identificar el sujeto 'noi.'"
  - "Seleccionar la conjugación correcta de 'correre' en futuro."
opciones_explicitas:  
  - "correremo"  
  - "corriamo"  
  - "corrono"  
...
### 11 — Futuro con "cucinare" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
### 12 — Futuro con "comprare" (opciones)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
pasos:  
  - "Identificar el sujeto 'lei.'"
  - "Seleccionar la conjugación correcta de 'comprare' en futuro."
opciones_explicitas:  
  - "comprerà"  
  - "compro"  
  - "compra"  
...
### 13 — Futuro con "leggere" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
### 14 — Futuro con "dormire" (opciones)  
```  
metadata:  
  materia: "italiano"  
  tema: "futuro"  
  nivel: "B1"  
  tags: ["pronombre", "futuro simples"]  
pasos:  
  - "Identificar el sujeto 'loro' y aplicar la forma del futuro."  
  - "Elegir entre las opciones de verbo conjugado en futuro."  
opciones_explicitas:  
  - "incontrerò"  
  - "incontrerai"  
  - "incontrerà"  
  ...
  - "incontrerete"  
  - "incontreranno"  
respuesta: "incontreranno"  
enunciado: "Domani loro ___ i colleghi in ufficio."  
explicacion: "El sujeto 'loro' (ellos/ellas) requiere la forma del futuro en tercera persona plural. La conjugación correcta de 'incontrare' es 'incontreranno'."  
```

### 15 — Futuro con "andare" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
pasos:  
  - "Identificar el sujeto 'voi.'"
  - "Seleccionar la conjugación correcta de 'fare' en futuro."
opciones_explicitas:  
  - "farete"  
  - "faccio"  
  - "fate"  
...
### 17 — Futuro con "prendere" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
### 18 — Futuro con "aspettare" (opciones)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
pasos:  
  - "Identificar el sujeto 'lui.'"
  - "Seleccionar la conjugación correcta de 'aspettare' en futuro."
opciones_explicitas:  
  - "aspetterà"  
  - "aspetto"  
  - "aspetta"  
...
### 19 — Futuro con "vedere" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
### 20 — Futuro con "correre" (opciones)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
### 21 — Futuro con "mangiare" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
### 23 — Futuro con "dormire" (completar)  
```  
metadata:  
  materia: "idiomas-extranjeros/italiano"  
  tema: "futuro"  
...
pasos:  
  - "Identificar el sujeto 'noi.'"
  - "Seleccionar la conjugación correcta de 'andare' en futuro."
opciones_explicitas:  
  - "andremo"  
  - "andiamo"  
  - "andate"  
...
### 25 — Futuro con "finire" (completar)  
```  
metadata:  
  materia: "italiano"  
  tema: "futuro"  
  nivel: "B1"  
  tags: ["pronombre", "verbo irregular"]  
pasos:  
  - "Reconocer que 'prenderà' es la forma futura del verbo irregular 'prendere'."  
  - "Verificar que el sujeto 'lei' (ella) concuerde con la conjugación."  
respuesta: "prenderà"  
respuestas_validas:  
  - "prenderà"  
  - "Prenderà"  
enunciado: "Domani lei ___ il treno delle otto."  
explicacion: "'Prendere' es en realidad un verbo regular en futuro (no irregular): su forma para 'lei' (ella) es 'prenderà', siguiendo el patrón estándar de los verbos en '-ere'."  
```
