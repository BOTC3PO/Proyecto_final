# Idiomas — Portugués (Brasil) — discurso-indireto (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/portugues-br/discurso-indireto/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.

---

### 1 — Transformação de oração  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["transformar", "verbo", "tempo"]
pasos:
...
### 6 — Uso de orações subordinadas  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["subordinação", "conjunção"]
pasos:
...
### 7 — Transformação com tempo futuro  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["tempo futuro", "verbo"]
pasos:
...
### 9 — Transformação com oração interrogativa  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["interrogativa", "verbo"]
pasos:
...
### 10 — Uso de pronomes em orações subordinadas  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["pronome", "subordinação"]
pasos:
...
### 11 — Transformação com oração subordinada adverbial  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["adverbial", "verbo"]
pasos:
...
### 12 — Uso de verbos no infinitivo  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["infinitivo", "verbo"]
pasos:
...
### 13 — Transformação com oração subordinada causal  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
...
### 14 — Uso de pronomes reflexivos  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["reflexivo", "pronome"]
pasos:
...
### 15 — Transformação com oração subordinada temporal  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
...
### 16 — Uso de expressões temporais  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["temporal", "expressão"]
pasos:
...
### 17 — Transformação com oração subordinada concessiva  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["concessiva", "verbo"]
pasos:
...
### 18 — Uso de expressões causais  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["causal", "expressão"]
pasos:
...
### 19 — Transformação com oração subordinada comparativa  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["comparativa", "verbo"]
pasos:
...
### 20 — Uso de expressões modais  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["modal", "expressão"]
pasos:
...
### 21 — Transformação com oração subordinada condicional  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["condicional", "verbo"]
pasos:
...
### 22 — Uso de expressões temporais  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
...
### 23 — Transformação com oração subordinada consecutiva  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
  nivel: "B2"
  tags: ["consecutiva", "verbo"]
pasos:
...
### 25 — Transformação com oração subordinada final  
```
metadata:
  materia: "idiomas-extranjeros/portugues-br"
  tema: "discurso-indireto"
