# Idiomas — Portugués (Brasil) — writing-b2 (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/portugues-br/writing-b2/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.
...
respuestas_validas:  
  ...
  - "Homogênea"  
tipo: completar  
explicacion: "O substantivo 'equipe' é feminino singular. O adjetivo 'homogênea' concorda em gênero e número com o substantivo."  
```

### 2 — Uso do gerúndio em oração subordinada  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["gerúndio", "oración subordinada"]  
pasos:  
...
pasos:  
  - "Identificar o verbo e sua relação com a preposição."  
...
### 4 — Concordância de pronome relativo com antecedente  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["pronome relativo", "antecedente"]  
pasos:  
...
respuestas_validas:  
  ...
  - "QUE"  
tipo: completar  
explicacion: "O antecedente 'o livro' é masculino singular. O pronome relativo 'que' concorda em gênero e número."  
```

### 5 — Uso do infinitivo pessoal com verbo de desejo  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["infinitivo pessoal", "verbo de desejo"]  
pasos:  
  - "Identificar o verbo que exige o infinitivo pessoal."  
...
### 6 — Uso de crase com artigo definido  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  ...
  tags: ["crase", "artigo"]  
pasos:  
  - "Verificar se o artigo 'a' está seguido de uma palavra que começa com 'a'."  
...
### 7 — Uso do pretérito mais-que-perfeito do indicativo  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["pretérito mais-que-perfeito", "indicativo"]  
pasos:  
  - "Identificar a relação de tempo entre as ações."  
...
### 8 — Uso da conjunção adversativa  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
...
pasos:  
  - "Identificar a relação de contraste entre as orações."  
...
### 9 — Uso do particípio passado com verbo auxiliar  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["particípio", "verbo auxiliar"]  
pasos:  
  - "Identificar o verbo principal e seu particípio passado."  
...
### 10 — Uso do verbo de ligação com adjetivo  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["verbo de ligação", "adjetivo"]  
pasos:  
  - "Identificar o verbo de ligação (ser, estar, parecer)."  
...
### 11 — Uso do gerúndio em oração principal  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["gerúndio", "oração principal"]  
pasos:  
  - "Identificar a ação contínua ou simultânea."  
...
### 12 — Uso do pronome reflexivo com verbo  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["pronome reflexivo", "verbo"]  
pasos:  
...
### 13 — Uso do infinitivo pessoal com verbo de ordem  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["infinitivo pessoal", "verbo de ordem"]  
pasos:  
  - "Identificar o verbo que exige o infinitivo pessoal."  
  - "Escolher a forma correta do infinitivo com sujeito."  
...
### 14 — Uso do particípio passado com sujeito indeterminado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["particípio", "sujeito indeterminado"]  
pasos:  
...
### 15 — Uso do verbo de ligação com substantivo  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["verbo de ligação", "substantivo"]  
pasos:  
  - "Identificar o verbo de ligação (ser, estar)."  
...
### 16 — Uso da conjunção causal  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["conjunção", "causal"]  
pasos:  
  - "Identificar a relação de causa entre as orações."  
...
### 17 — Uso do gerúndio em oração subordinada adjetiva  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["gerúndio", "oração subordinada"]  
pasos:  
...
respuestas_validas:  
  ...
  - "QUE"  
tipo: completar  
explicacion: "O gerúndio 'havia enviado' está na oração principal. O pronome relativo 'que' concorda com o antecedente masculino singular."  
```

### 18 — Uso do verbo de ligação com predicativo nominal  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["verbo de ligação", "predicativo"]  
pasos:  
  - "Identificar o verbo de ligação e seu predicativo."  
...
### 19 — Uso do infinitivo pessoal com verbo de recomendação  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
  nivel: "B2"  
  tags: ["infinitivo pessoal", "verbo de recomendação"]  
pasos:  
  - "Identificar o verbo que exige o infinitivo pessoal."  
  - "Escolher a forma correta do infinitivo com sujeito."  
...
### 20 — Uso do particípio passado com sujeito indeterminado e concordância  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "writing-b2"  
...
### 21 — Uso do verbo de ligação com predicativo adjetivo  
```
metadata:
...
pasos:
  - "Identificar a estrutura da oração subordinada."
...
### 22 — Uso do gerúndio em oração principal  
```
metadata:
  materia: "portugues-br"
  tema: "concordancia-corretiva"
  nivel: "B2"
  tags: ["corretivas", "concordância"]
pasos:
  - "Identificar a estrutura da oração com corretivas."
...
### 23 — Uso do pronome reflexivo com verbo  
```
metadata:
  materia: "portugues-br"
  tema: "condições-reais"
  nivel: "B2"
  tags: ["condições", "se"]
pasos:
  - "Reconocer que a condição é real e atual."
...
### 24 — Uso do infinitivo pessoal com verbo de ordem  
```
metadata:
  materia: "portugues-br"
  tema: "preposições-verbos"
  nivel: "B2"
  tags: ["depender", "preposição"]
pasos:
  - "Identificar o verbo 'depender' e sua preposição fixa."
...
### 25 — Uso do particípio passado com sujeito indeterminado e concordância  
```
metadata:
  materia: "portugues-br"
  tema: "frases-relativas"
  nivel: "B2"
  tags: ["relativas", "que"]
pasos:
  - "Identificar a oração principal e o sujeito da frase relativa."
