# Idiomas — Portugués (Brasil) — speaking-b2 (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/portugues-br/speaking-b2/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.

---

### 1 — Pretérito perfeito do verbo "ir"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["verbos", "pretérito-perfeito"]  
pasos:  
...
### 2 — Uso de "ter" + participio  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["verbo-ter", "participio"]  
pasos:  
...
### 3 — Pretérito imperfeito de un verbo regular (-ar)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["verbos", "pretérito-imperfeito"]  
pasos:  
...
### 4 — Uso del subjuntivo en oraciones condicionales  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["subjuntivo", "condicional"]  
pasos:  
  - "Reconocer la necesidad de subjuntivo en oraciones condicionales."  
  - "Verificar el sujeto 'se' y el verbo 'viver'."  
opciones_explicitas:  
  - "se vivesse"  
  - "se vive"  
  - "se vivia"  
...
### 5 — Preposición después de "lutar contra"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["preposiciones", "verbo-lutar"]  
pasos:  
...
### 6 — Concordancia de adjetivos con sustantivos femeninos  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
...
pasos:  
  - "Reconocer que el sustantivo 'mulher' es femenino."  
  - "Ajustar el adjetivo 'poderoso' a la concordancia de género."  
opciones_explicitas:  
  - "uma mulher poderosa"  
  - "uma mulher poderoso"  
  - "um homem poderosa"  
  - "umas mulheres poderosos"  
...
### 7 — Uso de "haver" como verbo impersonal  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
...
### 8 — Uso de "ser" + adjetivo en oraciones comparativas  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["comparativos", "adjetivos"]  
pasos:  
  - "Reconocer la estructura 'ser + más/menos + adjetivo'."  
  - "Verificar el sujeto 'esse filme' y el adjetivo 'interessante'."  
opciones_explicitas:  
  - "esse filme é mais interessante"  
  - "esse filme é mais interesante"  
  - "esse filme são mais interessante"  
  - "esse filme é menos interessante"  
...
### 9 — Uso de "ter que" para obligación futura  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["obligação", "ter-que"]  
pasos:  
...
### 10 — Pretérito perfeito do verbo "fazer"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
...
### 11 — Uso de "a" como preposición de movimiento  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["preposiciones", "movimento"]  
pasos:  
...
### 12 — Concordancia de pronombres con sustantivos plurales  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["pronombres", "concordancia"]  
pasos:  
  - "Reconocer que el sustantivo 'estudantes' es plural."  
  - "Ajustar el pronombre a la concordancia de número."  
opciones_explicitas:  
  - "Eles são os estudantes"  
  - "Elas são os estudantes"  
  - "Ela é os estudantes"  
  - "Eles são as estudantes"  
...
### 13 — Uso de "poder" para posibilidad en presente  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["modalidades", "posibilidad"]  
pasos:  
...
### 14 — Pretérito imperfeito de un verbo irregular (-er)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
...
### 15 — Uso de "ser" + adjetivo en oraciones de opinión  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["opinión", "adjetivos"]  
pasos:  
  - "Reconocer la estructura 'ser + adjetivo' para expresar opinión."  
  - "Verificar el sujeto 'esse filme' y el adjetivo 'interessante'."  
opciones_explicitas:  
  - "esse filme é interessante"  
  - "esse filme são interessante"  
  - "esse filme é interesante"  
  - "esse filme é mais interessante"  
...
### 16 — Uso de "ter" como verbo de posesión  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["verbo-ter", "posesión"]  
pasos:  
...
### 17 — Pretérito perfeito do verbo "ler"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
...
### 18 — Uso de "ser" + adjetivo para descripción física  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["descripción", "adjetivos"]  
pasos:  
  - "Reconocer la estructura 'ser + adjetivo' para describir características físicas."  
  - "Verificar el sujeto 'esse homem' y el adjetivo 'alto'."  
opciones_explicitas:  
  - "esse homem é alto"  
  - "esse homem são alto"  
  - "esse homem é altos"  
  - "esse homem é mais alto"  
...
### 19 — Uso de "haver" como verbo impersonal en oraciones negativas  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
...
### 20 — Uso de "ser" + adjetivo para descripción de emociones  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["emociones", "adjetivos"]  
pasos:  
  - "Reconocer la estructura 'ser + adjetivo' para describir emociones."  
  - "Verificar el sujeto 'ela' y el adjetivo 'feliz'."  
opciones_explicitas:  
  - "ela é feliz"  
  - "ela são feliz"  
  - "ela é felizes"  
...
### 21 — Pretérito perfeito do verbo "dizer"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
...
### 22 — Uso de "ter que" para obligación presente  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["obrigação", "ter-que"]  
pasos:  
...
### 23 — Uso de "ser" + adjetivo en oraciones de identidad  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
  nivel: "B2"  
  tags: ["identidade", "adjetivos"]  
pasos:  
  - "Reconocer la estructura 'ser + adjetivo' para identificar características."  
  - "Verificar el sujeto 'essa pessoa' y el adjetivo 'bondosa'."  
opciones_explicitas:  
  - "essa pessoa é bondosa"  
  - "essa pessoa são bondosas"  
  - "essa pessoa é bondoso"  
  - "essa pessoa é mais bondosa"  
...
### 24 — Pretérito perfeito do verbo "trazer"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "speaking-b2"  
