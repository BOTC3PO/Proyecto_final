# Idiomas — Portugués (Brasil) — listening-a2 (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/portugues-br/listening-a2/cuestionario_crudo.md`)
...
### 1 — Horário de transporte  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["horários", "transporte"]  
pasos:  
...
metadata:  
  ...
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["alimentación", "preferencias"]  
pasos:  
...
metadata:  
  ...
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["direções", "verbos de movimiento"]  
pasos:  
...
### 8 — Adjetivos de color  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["colores", "descripciones"]  
pasos:  
...
### 13 — Conexión de oraciones  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["conectores", "relación"]  
pasos:  
...
### 16 — Adjetivos de tamaño  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adjetivos", "tamaño"]  
pasos:  
...
### 17 — Adverbios de modo  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adverbios", "manera"]  
pasos:  
...
### 21 — Adjetivos de forma  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adjetivos", "forma"]  
pasos:  
...
### 22 — Preposiciones de pertenencia  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-br"  
  tema: "listening-a2"  
