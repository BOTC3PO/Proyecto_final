# Idiomas — Portugués (Portugal) — ser-estar (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/portugues-pt/ser-estar/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.
...
### 5 — Uso de "ser" en nacionalidad  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
  nivel: "A1"  
  tags: ["ser", "nacionalidad"]  
pasos:  
...
### 6 — Uso de "estar" en emociones  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
  nivel: "A1"  
  tags: ["estar", "emociones"]  
pasos:  
...
### 7 — Uso de "ser" en descripción física  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 8 — Uso de "estar" en estado de salud  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 9 — Elección entre "ser" y "estar" (profesión vs. lugar)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
  nivel: "A2"  
  tags: ["elección", "contexto"]  
pasos:  
  - "Analizar si el contexto describe un rol permanente o una situación actual."  
  - "Seleccionar 'ser' para profesiones y 'estar' para ubicaciones."  
respuesta: "é"  
tipo: mc  
opciones_explicitas:  
  - "é"  
...
### 10 — Uso de "ser" en relación familiar  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 11 — Uso de "estar" en condiciones climáticas  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 12 — Uso de "ser" en cualidades permanentes  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 13 — Uso de "estar" en estado emocional actual  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 14 — Elección entre "ser" y "estar" (profesión vs. emoción)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
  ...
  tags: ["elección", "contexto"]  
pasos:  
  - "Analizar si el contexto describe un rol permanente o una situación emocional."  
  - "Seleccionar 'ser' para profesiones y 'estar' para emociones."  
respuesta: "é"  
tipo: mc  
opciones_explicitas:  
  - "é"  
...
### 15 — Uso de "ser" en descripción de lugar fijo  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 16 — Uso de "estar" en estado de salud temporal  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 17 — Uso de "ser" en relación profesional  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 18 — Uso de "estar" en ubicación temporal  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 19 — Elección entre "ser" y "estar" (nacionalidad vs. emoción)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
  ...
  tags: ["elección", "contexto"]  
pasos:  
  - "Analizar si el contexto describe una nacionalidad o una emoción."  
  - "Seleccionar 'ser' para orígenes y 'estar' para emociones."  
respuesta: "é"  
tipo: mc  
opciones_explicitas:  
  - "é"  
...
### 20 — Uso de "ser" en descripción de personalidad  
```  
metadata:  
...
respuestas_validas:  
  ...
  - "é"  
enunciado: "O Pedro ___ advogado e trabalha em São Paulo."  
explicacion: "O verbo 'ser' é usado para profissões (advogado) que são permanentes. A forma correta no presente do indicativo para o sujeito 'O Pedro' é 'é'."  
```

### 21 — Uso de "estar" en estado emocional temporal  
```  
metadata:  
  materia: "portugues-pt"  
  tema: "ser-estar"  
  nivel: "A2"  
  tags: ["localizacao", "estar"]  
pasos:  
  - "Determinar se a oração descreve um estado temporário (uso de 'estar')."  
  - "Selecionar a opção correta com base no sujeito e contexto."  
respuesta: "está"  
tipo: mc  
opciones_explicitas:  
  - "está"  
  - "é"  
  - "faz"  
enunciado: "O livro ___ no armário da cozinha agora."  
explicacion: "A oração descreve a localização temporária do livro ('agora'), que exige o uso de 'estar'. A forma correta é 'está', pois concorda em número e pessoa com o sujeito singular 'o livro'."  
```

### 22 — Elección entre "ser" y "estar" (lugar vs. emoción)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
  ...
  tags: ["elección", "contexto"]  
pasos:  
  - "Analizar si el contexto describe un lugar fijo o una emoción."  
  - "Seleccionar 'ser' para ubicaciones permanentes y 'estar' para emociones."  
respuesta: "é"  
tipo: mc  
opciones_explicitas:  
  - "é"  
...
### 23 — Uso de "ser" en descripción de profesión y nacionalidad  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 24 — Uso de "estar" en ubicación temporal y estado emocional  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
...
### 25 — Elección entre "ser" y "estar" (profesión vs. emoción)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "ser-estar"  
  ...
  tags: ["elección", "contexto"]  
pasos:  
  - "Analizar si el contexto describe una profesión o una emoción."  
  - "Seleccionar 'ser' para roles fijos y 'estar' para emociones temporales."  
respuesta: "é"  
tipo: mc  
opciones_explicitas:  
  - "é"  
  - "está"  
  - "faz"  
enunciado: "O Pedro ___ engenheiro e ___ feliz com seu trabalho."  
variables: {}  
explicacion: "'Ser' describe la profesión permanente ('engenheiro'), mientras que 'estar' indica su estado emocional actual ('feliz')."
