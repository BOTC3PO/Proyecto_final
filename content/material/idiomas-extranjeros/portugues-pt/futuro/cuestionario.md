# Idiomas — Portugués (Portugal) — futuro (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/portugues-pt/futuro/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.

---

### 1 — Futuro de verbos regulares  
```  
metadata:  
...
### 2 — Futuro con "vou + infinitivo"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  nivel: "B1"  
  tags: ["futuro", "estructura"]  
pasos:  
  - "Elige la opción correcta para expresar un plan futuro."  
...
### 3 — Futuro de verbos irregulares  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
pasos:  
  - "Elige la opción correcta para expresar una condición futura."  
respuesta: "Vou estudiar"  
tipo: mc  
opciones_explicitas:  
  - "Estudarei"  
  - "Vou estudiar"  
...
### 5 — Futuro con pronombres reflexivos  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 6 — Futuro con expresión temporal  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  nivel: "B1"  
  tags: ["temporal", "futuro"]  
pasos:  
  - "Elige la opción correcta para completar la oración con una expresión temporal."  
respuesta: "Vou viajar"  
tipo: mc  
opciones_explicitas:  
  - "Viajarei"  
  - "Vou viajar"  
...
### 10 — Futuro con expresión de hipótesis  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  nivel: "B1"  
  tags: ["hipótesis", "futuro"]  
pasos:  
  - "Elige la opción correcta para expresar una hipótesis futura."  
respuesta: "Vou aprender"  
tipo: mc  
opciones_explicitas:  
  - "Aprenderé"  
  - "Vou aprender"  
...
### 11 — Futuro con "dever" (obligación)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 12 — Futuro con pronombres directos e indirectos  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 13 — Futuro en oración de propósito  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  nivel: "B1"  
  tags: ["propósito", "futuro"]  
pasos:  
  - "Elige la opción correcta para expresar un propósito futuro."  
respuesta: "Vou me preparar"  
tipo: mc  
opciones_explicitas:  
  - "Prepararei"  
  - "Vou me preparar"  
...
### 14 — Futuro con "ter que" (necesidad)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 15 — Futuro con verbos compuestos (passado)  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 16 — Futuro en oración de consejo  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  ...
  tags: ["consejo", "futuro"]  
pasos:  
  - "Elige la opción correcta para expresar un consejo futuro."  
respuesta: "Vou te ajudar"  
tipo: mc  
opciones_explicitas:  
  - "Ajudarei"  
  - "Vou te ajudar"  
...
### 17 — Futuro con expresión de probabilidad  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 18 — Futuro en oración de promesa  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  ...
  tags: ["promesa", "futuro"]  
pasos:  
  - "Elige la opción correcta para expresar una promesa futura."  
respuesta: "Vou pagar"  
tipo: mc  
opciones_explicitas:  
  - "Pagarei"  
...
### 19 — Futuro con verbos impersonales  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 20 — Futuro con expresión de tiempo futuro  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 21 — Futuro en oración de opinión futura  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  ...
  tags: ["opinión", "futuro"]  
pasos:  
  - "Elige la opción correcta para expresar una opinión futura."  
respuesta: "Vou achar"  
tipo: mc  
opciones_explicitas:  
  - "Acharei"  
...
### 22 — Futuro con verbos reflexivos compuestos  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 23 — Futuro con expresión de duda futura  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 24 — Futuro con verbos de cambio de estado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
...
### 25 — Futuro con expresión de tiempo indefinido  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "futuro"  
  ...
  tags: ["tiempo", "futuro"]  
pasos:  
  - "Elige la opción correcta para expresar un tiempo indefinido futuro."  
respuesta: "Vou trabalhar"  
tipo: mc  
opciones_explicitas:  
  - "Trabalharei"  
  - "Vou trabalhar"  
  - "Trabalharé"  
enunciado: "_____ em uma empresa internacional, se conseguir o emprego."  
variables: []  
explicacion: "La estructura 'vou + infinitivo' se usa con expresiones de tiempo indefinido. La forma correcta es 'Vou trabalhar'."
