# Idiomas — Portugués (Portugal) — subjuntivo-completo (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/portugues-pt/subjuntivo-completo/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.

---

### 1 — Subjuntivo após "é preciso que"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["necessidade", "presente"]  
pasos:  
...
### 2 — Subjuntivo após "desejo que"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["desejo", "presente"]  
pasos:  
  - "Reconhecer a expressão que exige subjuntivo."  
...
### 3 — Subjuntivo em oração de dúvida com "duvido que"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["dúvida", "presente"]  
pasos:  
  - "Identificar a expressão de dúvida."  
...
### 4 — Subjuntivo após "recomendo que" com sujeito indeterminado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["sugestão", "presente"]  
pasos:  
  - "Reconhecer a sugestão implícita no verbo principal."  
...
### 5 — Subjuntivo em oração de tempo com "quando"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["tempo", "pretérito"]  
pasos:  
  - "Identificar a expressão de tempo."  
...
### 6 — Subjuntivo após "não é possível que"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["impossibilidade", "presente"]  
pasos:  
  - "Reconhecer a expressão de impossibilidade."  
...
### 7 — Subjuntivo em oração de desejo com "espero que"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  ...
  tags: ["desejo", "presente"]  
pasos:  
  - "Identificar a expressão de desejo."  
  - "Aplicar o subjuntivo presente à oração subordinada."  
...
### 8 — Subjuntivo após "necessito que" com sujeito indeterminado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  ...
  tags: ["necessidade", "presente"]  
pasos:  
  - "Reconhecer a necessidade expressa no verbo principal."  
  - "Usar o subjuntivo presente para sujeito indeterminado."  
...
### 9 — Subjuntivo em oração de hipótese com "se" e tempo passado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["hipótese", "pretérito"]  
pasos:  
  - "Identificar a hipótese não confirmada."  
...
### 10 — Subjuntivo após "não importa que" com sujeito plural  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["indiferença", "presente"]  
pasos:  
  - "Reconhecer a expressão de indiferença."  
...
### 11 — Subjuntivo após "como se" com sujeito indeterminado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["comparação", "presente"]  
pasos:  
  - "Identificar a expressão de comparação."  
  - "Usar o subjuntivo presente para sujeito indeterminado."  
...
### 12 — Subjuntivo em oração de emoção com "fico feliz que"  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["emoção", "presente"]  
pasos:  
  - "Reconhecer a emoção expressa no verbo principal."  
  - "Aplicar o subjuntivo presente à oração subordinada."  
...
### 13 — Subjuntivo após "não é possível que" com sujeito plural  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  ...
  tags: ["impossibilidade", "presente"]  
pasos:  
  - "Identificar a expressão de impossibilidade."  
  - "Usar o subjuntivo presente para sujeito plural."  
...
### 14 — Subjuntivo em oração de tempo com "antes que" e tempo passado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
...
### 15 — Subjuntivo após "pedi que" com sujeito indeterminado  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  ...
  tags: ["ordem", "presente"]  
pasos:  
  - "Reconhecer a ordem implícita no verbo principal."  
  - "Usar o subjuntivo presente para sujeito indeterminado."  
...
### 16 — Subjuntivo em oração de hipótese com "se" e tempo presente  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["hipótese", "presente"]  
pasos:  
  - "Identificar a hipótese não confirmada."  
...
### 17 — Subjuntivo após "não importa que" com sujeito singular  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
...
### 18 — Subjuntivo em oração de tempo com "quando" e tempo passado  
```  
metadata:  
  ...
  tags: ["condicional", "se"]  
pasos:  
  - "Identificar el contexto de la oración para determinar si se usa el subjuntivo."  
...
### 19 — Subjuntivo após "desejo que" com sujeito plural  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
...
### 20 — Subjuntivo em oração de hipótese com "se" e tempo passado  
```  
metadata:  
  materia: "portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["deseo", "recomendar"]  
pasos:  
  - "Reconocer que 'recomendar que' exige el subjuntivo."  
...
### 21 — Subjuntivo após "pedi que" com sujeito plural  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
...
### 22 — Subjuntivo em oração de tempo com "antes que" e tempo presente  
```  
metadata:  
  materia: "portugues-pt"  
  tema: "subjuntivo-completo"  
  nivel: "B2"  
  tags: ["negación", "possível"]  
pasos:  
  - "Identificar que 'não é possível que' introduce una negación de posibilidad, lo cual exige subjuntivo."  
  - "Elegir la forma correcta del subjuntivo en terceira pessoa do singular."  
explicacion: "'Não é possível que' se usa para expresar imposibilidad, por lo tanto requiere el subjuntivo. La forma adecuada es 'seja' (subjuntivo presente)."  
tipo: mc  
opciones_explicitas:  
  - "é"  
  - "seja"  
...
### 24 — Subjuntivo em oração de hipótese com "se" e tempo presente  
```  
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "subjuntivo-completo"  
...
pasos:  
  - "Identificar a hipótese não confirmada."  
  - "Aplicar o subjuntivo presente quando necessário."  
explicacion: "Orações condicionais com 'se' exigem o subjuntivo se houver incerteza sobre a realização do fato. Neste caso, o uso do presente indica uma hipótese não confirmada no
