...
> `_borradores-gemma/idiomas-extranjeros/japones/comparacion/cuestionario_crudo.md`
> mediante el script `mechanical_fix_idiomas.py` (comillas mal cerradas o ausentes en
> `enunciado:`/`explicacion:`). Se quitaron además 5 entradas de `respuestas_validas:`
> que eran artefactos de prueba sin sentido, marcados literalmente "(no válido,
> incluido para prueba)" en el propio borrador. Se corrigió un error de contenido: los
> bloques 3 y 7 combinaban un i-adjetivo sin negar directamente con ではありません
> ("安いではありません"), una construcción agramatical -- los i-adjetivos se niegan
> quitando la い final y añadiendo くありません, nunca con ではありません (que es sólo
> para sustantivos y na-adjetivos). Se corrigió el enunciado del bloque 3 y la
> explicación de ambos bloques (el bloque 7 ya usaba correctamente 面白くありません en
> su enunciado, pero su explicación citaba la regla equivocada).
...
metadata:  
  ...
  tema: "comparacion"  
  nivel: "N4"  
  tags: ["comparativo", "mas que"]  
pasos:  
  - "Completa el hueco con la forma correcta de 'より'."  
...
metadata:  
  ...
  tags: ["as...como", "ほど"]  
pasos:  
  - "Elige la opción que completa correctamente el hueco."  
explicacion: "La estructura [A]は[B]ほど[C]です se usa para 'tan...como'."  
tipo: mc  
enunciado: "彼は私___背が高いです。"  
opciones_explicitas:  
  - "より"  
  - "ほど"  
  - "と"  
...
metadata:  
  ...
  tags: ["menos que", "より"]  
pasos:  
  - "Completa el hueco con la forma correcta de 'より' en negativo."  
explicacion: "Para expresar 'no tan...como', se usa [A]は[B]より[C]くありません (los i-adjetivos se niegan quitando la い final y añadiendo くありません, nunca con ではありません)。"  
tipo: completar  
enunciado: "このレストランはあの店___安くありません。"  
respuestas_validas:  
  - "より"  
```
...
explicacion: "La comparación de tiempo usa 'より' después del verbo."  
tipo: mc  
enunciado: "昨日の授業は今日___短かったです。"  
opciones_explicitas:  
  - "より"  
  - "ほど"  
  - "と"  
...
metadata:  
  ...
  tags: ["as...como", "ほど"]  
pasos:  
  - "Completa el hueco con la forma correcta de 'ほど'."  
...
pasos:  
  - "Elige la opción correcta para completar el hueco."  
explicacion: "La comparación de habilidades usa 'より' después del verbo."  
tipo: mc  
enunciado: "彼女は私___英語が上手です。"  
opciones_explicitas:  
  - "より"  
  - "ほど"  
  - "と"  
...
pasos:  
  - "Completa el hueco con la forma correcta de 'より' en negativo."  
explicacion: "Para 'no tan...como', se usa [A]は[B]より[C]くありません (los i-adjetivos se niegan quitando la い final y añadiendo くありません, nunca con ではありません)。"  
tipo: completar  
...
metadata:
  ...
  tema: "comparacion"
  nivel: "N4"
  tags: ["comparacion", "mas", "menos"]
pasos:
  - "Identificar el sujeto y el complemento en la oración."
  - "Determinar si se requiere 'mas' o 'menos' según el contexto."
respuestas_validas:
  - "より"
  - "より"
tipo: completar
...
metadata:
  ...
  tema: "comparacion"
  nivel: "N4"
  tags: ["comparacion", "preposiciones"]
pasos:
  - "Revisar las opciones para identificar la preposición correcta."
  - "Seleccionar la opción que indica comparación directa."
opciones_explicitas:
  - "と比べて"
  - "より"
  - "ほど"
