# Idiomas — Francés — genero-y-concordancia (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/frances/genero-y-concordancia/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.
...
metadata:  
  ...
  tema: "genero-y-concordancia"  
  nivel: "A1"  
  tags: ["articulo", "masculino"]  
pasos:  
...
### 4 — El adjetivo masculino plural  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
  nivel: "A1"  
  tags: ["adjetivo", "plural"]  
pasos:  
...
### 5 — El verbo en singular femenino  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 6 — El adjetivo neutro  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
  nivel: "A1"  
  tags: ["adjetivo", "neutro"]  
pasos:  
...
### 7 — El artículo con sustantivo femenino  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
  nivel: "A1"  
  tags: ["articulo", "femenino"]  
pasos:  
  - "Determinar el género del sustantivo."  
  - "Elegir el artículo correspondiente."  
tipo: completar  
...
### 8 — El adjetivo masculino singular  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 9 — El verbo en plural masculino  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 10 — El adjetivo femenino invariable  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
  nivel: "A1"  
  tags: ["adjetivo", "invariable"]  
pasos:  
  - "Identificar si el sustantivo es invariable."  
  - "Verificar que el adjetivo no cambie de forma."  
tipo: completar  
...
### 11 — El artículo con sustantivo masculino plural  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
  nivel: "A1"  
  tags: ["articulo", "plural"]  
pasos:  
  - "Determinar el género y número del sustantivo."  
  - "Elegir el artículo correspondiente."  
tipo: completar  
...
### 12 — El adjetivo femenino plural  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 13 — El verbo en singular masculino  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
  nivel: "A1"  
  tags: ["verbo", "masculino"]  
pasos:  
  - "Identificar el sujeto y su género."  
  - "Elegir la conjugación correcta del verbo."  
tipo: completar  
...
### 14 — El adjetivo masculino invariable  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
  nivel: "A1-A2"
  tags: ["adjetivo", "femenino", "singular"]
pasos:
...
### 15 — El artículo con sustantivo femenino plural  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 16 — El adjetivo masculino singular  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 17 — El verbo en plural femenino  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 18 — El adjetivo masculino invariable  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
  nivel: "A1-A2"
  tags: ["adjetivo", "masculino", "plural"]
pasos:
...
### 19 — El artículo con sustantivo masculino singular  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
  nivel: "A1-A2"
  tags: ["adjetivo", "masculino", "singular"]
pasos:
...
### 20 — El adjetivo femenino singular  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
  nivel: "A1-A2"
  tags: ["adjetivo", "femenino", "plural"]
pasos:
  - "Identificar el número del sustantivo 'filles'."
  - "Elegir la forma correcta del adjetif que concuerde en género y número."
opciones_explicitas:
  - "intelligentes"
  - "intelligente"
...
### 21 — El verbo en singular femenino  
```  
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "genero-y-concordancia"  
...
### 22 — El adjetivo masculino plural  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
...
### 23 — El artículo con sustantivo femenino singular  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
  nivel: "A1-A2"
  tags: ["adjetivo", "neutro", "plural"]
pasos:
  - "Identificar el género del sustantivo 'pommes'."
  - "Elegir la forma correcta del adjetif que concuerde en género y número."
opciones_explicitas:
  - "rouges"
  - "rouge"
...
### 24 — El adjetivo masculino singular  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
...
### 25 — El verbo en plural masculino  
```
metadata:
  materia: "frances"
  tema: "genero-y-concordancia"
  ...
  tags: ["adjetivo", "femenino", "plural"]
pasos:
  - "Identificar el número del sustantivo 'fleurs'."
  - "Elegir la forma correcta del adjetif que concuerde en género y número."
opciones_explicitas:
  - "bleues"
  - "bleu"
