# Idiomas — Francés — speaking-b1 (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/frances/speaking-b1/cuestionario_crudo.md`)
...
### 1 — Accord du verbe dans les subordonnées  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["subjonctif", "accord"]  
pasos:  
  - "Identificar el sujeto de la subordinada."  
  - "Verificar si hay concordancia en número y persona con el verbo principal."  
...
### 2 — Uso del imperativo en negación  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["imperatif", "negation"]  
pasos:  
  - "Reconocer la forma del imperativo en negación."  
  - "Asegurar que el verbo esté en la conjugación correcta (tu = n'ajoutes pas)."  
...
### 3 — Uso del plus-que-parfait en narrativas  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
...
pasos:  
  ...
  - "Usar plus-que-parfait para acciones pasadas antes de otra acción pasada (le passé composé)."  
...
### 4 — Concordancia en oraciones relativas  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["relative", "accord"]  
pasos:  
  - "Identificar el antecedente del pronombre relativo."  
  - "Asegurar que el verbo concuerde con el antecedente (masculino singular)."  
...
### 5 — Uso del conditionnel présent en hipótesis  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["conditionnel", "hypothèse"]  
pasos:  
  - "Reconocer la estructura de una hipótesis irreal."  
  - "Usar el conditionnel présent para expresar un deseo o suposición."  
...
### 6 — Uso del subjonctif en oraciones impersonales  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["subjonctif", "impersonnel"]  
pasos:  
  - "Identificar si la oración comienza con un verbo impersonal (il faut, il est nécessaire)."  
  - "Usar el subjonctif presente para las subordinadas."  
...
### 7 — Uso del infinitif en oraciones negativas  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["infinitif", "negation"]  
pasos:  
  - "Reconocer la estructura 'ne...pas' con verbo infinitivo."  
  - "Asegurar que el verbo esté en forma correcta (être → être)."  
...
### 8 — Uso del passé composé con verbo pronominal  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["passé composé", "verbe pronominal"]  
pasos:  
  - "Identificar el verbo pronominal y su participe passé."  
  - "Colocar el pronombre réfléchi antes del auxiliar (se + être)."  
...
### 9 — Uso del futur simple en oraciones condicionales  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
...
pasos:  
  ...
  - "Usar el futur simple en la parte principal y conditionnel en la subordinada."  
...
### 10 — Uso del subjonctif en oraciones de duda o deseo  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["subjonctif", "doute"]  
pasos:  
  - "Identificar si la oración expresa duda o deseo."  
  - "Usar el subjonctif presente para las subordinadas."  
...
### 11 — Uso del participe passé con verbo de movimiento  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["participe passé", "verbe de mouvement"]  
pasos:  
  - "Identificar si el verbo es de movimiento (aller, venir)."  
  - "Usar 'être' como auxiliar y concordar el participio con el sujeto."  
...
### 12 — Uso del subjonctif en oraciones impersonales  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
...
### 13 — Uso del conditionnel passé en hipótesis irreal  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  ...
  tags: ["conditionnel", "hypothèse"]  
pasos:  
  - "Reconocer una hipótesis irreal en el pasado."  
  - "Usar el conditionnel passé para expresar un deseo no cumplido."  
...
### 14 — Uso del subjonctif en oraciones con 'que'  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  ...
  tags: ["subjonctif", "que"]  
pasos:  
  - "Identificar si la oración comienza con 'il faut que', 'je veux que', etc."  
  - "Usar el subjonctif presente para las subordinadas."  
...
### 15 — Uso del infinitif en oraciones de consejo  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "speaking-b1"  
  nivel: "B1"  
  tags: ["infinitif", "conseil"]  
pasos:  
  - "Reconocer la estructura 'il faut + infinitivo'."  
  - "Asegurar que el verbo esté en forma correcta (être → être)."  
explicacion: "La negación en infinitivo se forma con 'ne...pas'. Aquí, 'ne pas être' es la forma correcta para una prohibición o recomendación."  
...
### 16 — Uso del passé composé con verbo pronominal (2)  
```yaml
metadata:
  materia: "frances"
  tema: "subjonctif-b1"
  nivel: "B1"
  tags: ["il-faut-que", "subjuntivo"]
pasos:
  - "Identificar la estructura 'il faut que' que requiere el subjuntivo."
...
metadata:
  ...
  tema: "condicional-b1"
  nivel: "B1"
  tags: ["si-avions", "condicional"]
pasos:
  - "Reconocer la estructura 'Si + imparfait, conditional' para hipótesis irreal."
...
metadata:
  materia: "frances"
  tema: "passé-composé-b1"
  nivel: "B1"
  tags: ["passé-composé", "reflexivo"]
pasos:
  - "Identificar el verbo 'ranger' y su participe passé."
...
metadata:
  ...
  tema: "imperatif-b1"
  nivel: "B1"
  tags: ["imperativo", "sugerencia"]
pasos:
  - "Reconocer la forma del imperativo de 'être' para el tú."
...
metadata:
  ...
  tema: "futur-b1"
  nivel: "B1"
  tags: ["futuro", "condición"]
pasos:
  - "Identificar la estructura 'Quand + futur, verbo principal en futuro'."
...
metadata:
  ...
  tema: "subjonctif-b1"
  nivel: "B1"
  tags: ["je-doute-que", "subjuntivo"]
pasos:
  - "Reconocer la necesidad de subjuntivo tras 'je doute que'."
  - "Elegir la conjugación correcta del verbo en subjuntivo presente."
...
metadata:
  ...
  tema: "negacion-b1"
  nivel: "B1"
  tags: ["imperativo", "negación"]
pasos:
  - "Reconocer la estructura 'ne...pas' con el imperativo."
...
metadata:
  ...
  tema: "passé-composé-b1"
  nivel: "B1"
  tags: ["passé-composé", "manger"]
pasos:
  - "Identificar el verbo 'manger' y su participe passé."
...
metadata:
  materia: "frances"
  tema: "conditionnel-passé-b1"
  nivel: "B1"
  tags: ["conditionnel-passé", "si-avais-su"]
pasos:
  - "Reconocer la estructura 'Si + passé composé, conditionnel parfait'."
...
metadata:
  ...
  tema: "futur-b1"
  nivel: "B1"
  tags: ["futuro", "negación"]
pasos:
  - "Reconocer la estructura 'ne...pas' con el futuro."
  - "Elegir el verbo en futuro que complete correctamente."
