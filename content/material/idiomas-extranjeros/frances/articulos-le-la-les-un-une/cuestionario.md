# Idiomas — Francés — articulos-le-la-les-un-une (cuestionario)

> Promovido desde el borrador (`../../../_borradores-gemma/idiomas-extranjeros/frances/articulos-le-la-les-un-une/cuestionario_crudo.md`), ya validaba 0 FAIL, sin cambios de contenido.

---

### 1 — Article indéfini avec "un"  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["indefinido", "masculino"]  
pasos:  
...
### 2 — Artículo definido con "la"  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["definido", "femenino"]  
pasos:  
...
### 3 — Artículo indefinido con "une"  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["indefinido", "femenino"]  
pasos:  
...
### 4 — Artículo definido plural con "les"  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["definido", "plural"]  
pasos:  
...
### 5 — Artículo indefinido plural con "des"  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["indefinido", "plural"]  
pasos:  
...
### 6 — Artículo definido con "le"  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["definido", "masculino"]  
pasos:  
...
### 7 — Artículo indefinido con "un" en contexto de introducción  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["introducción", "masculino"]  
pasos:  
...
### 8 — Artículo definido con "la" para describir un objeto  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["objeto", "femenino"]  
pasos:  
...
### 9 — Artículo indefinido plural con "des" en contexto de existencia  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["existencia", "plural"]  
pasos:  
...
### 10 — Artículo definido con "le" en contexto de posesión  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["posesión", "masculino"]  
pasos:  
...
### 11 — Artículo indefinido con "une" para aludir a una persona  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["persona", "femenino"]  
pasos:  
...
### 12 — Artículo definido plural con "les" en contexto de grupos  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
...
### 13 — Artículo indefinido con "un" en contexto de elección  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["opción", "masculino"]  
pasos:  
...
### 14 — Artículo definido con "la" en contexto de descripción  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
  nivel: "A1"  
  tags: ["descripción", "femenino"]  
pasos:  
  - "Identificar el género del sustantivo 'chaise'"  
  - "Elegir el artículo definido correspondiente al género y número"  
tipo: completar  
...
### 15 — Artículo indefinido plural con "des" en contexto de existencia  
```
metadata:
  materia: "frances"
  tema: "articulos-le-la-les-un-une"
  nivel: "A1"
  tags: ["possessif", "de", "mon"]
pasos:
...
metadata:
  ...
  tema: "articulos-le-la-les-un-une"
  nivel: "A1"
  tags: ["il y a", "des", "plurales"]
pasos:
  - "Reconocer que el sustantivo es plural."
  - "Seleccionar 'des' para sustantivos plurales no específicos."
opciones_explicitas:
  - "un"
  - "une"
  - "des"
respuesta: "des"
tipo: mc
enunciado: "Il y a ___ fenêtres ouvertes dans la maison."
```

### 17 — Artículo indefinido con "une" en contexto de descripción  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
...
### 18 — Artículo definido plural con "les" en contexto de grupos  
```
metadata:  
  materia: "idiomas-extranjeros/frances"  
  tema: "articulos-le-la-les-un-une"  
...
### 19 — Artículo indefinido con "un" en contexto de elección  
```
metadata:
  materia: "frances"
  tema: "articulos-le-la-les-un-une"
...
respuestas_validas:
  ...
  - "le"
tipo: completar
enunciado: "___ livre sur la table est intéressant."
```

### 20 — Artículo definido con "la" en contexto de posesión  
```
metadata:
  materia: "frances"
  tema: "articulos-le-la-les-un-une"
  nivel: "A1"
  tags: ["je veux", "des", "plurales"]
pasos:
  - "Identificar que el sustantivo es plural y contable."
  - "Elegir 'des' para expresar una cantidad no específica de objetos."
opciones_explicitas:
  - "un"
  - "une"
  - "des"
respuesta: "des"
tipo: mc
enunciado: "Je veux ___ pommes pour la recette."
```

### 21 — Artículo indefinido plural con "des" en contexto de existencia  
```
metadata:
  materia: "frances"
  tema: "articulos-le-la-les-un-une"
  nivel: "A2"
  tags: ["possessif", "nos", "plurales"]
pasos:
...
respuestas_validas:
  ...
  - "Nos"
tipo: completar
enunciado: "Les enfants de ___ voisins sont ici."
```

### 22 — Artículo definido con "le" en contexto de posesión  
```
metadata:
  materia: "frances"
  tema: "articulos-le-la-les-un-une"
  nivel: "A1"
  tags: ["prépositions", "du", "bureau"]
pasos:
  - "Identificar la preposición que requiere el artículo contracto."
  - "Seleccionar 'du' (de + le) para sustantivos masculinos singulares."
opciones_explicitas:
  - "le"
  - "la"
  - "du"
respuesta: "du"
tipo: mc
enunciado: "À côté ___ bureau, il y a une chaise."
```

### 23 — Artículo indefinido con "une" en contexto de descripción  
```
metadata:
  materia: "frances"
  tema: "articulos-le-la-les-un-une"
...
respuestas_validas:
  ...
  - "Un"
tipo: completar
enunciado: "Il y a ___ chat noir dans le jardin."
```
