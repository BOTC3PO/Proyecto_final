...
> Tema: `oficios/modista-corte-y-confeccion/tecnicas-confeccion`. Ver `teoria.md` en esta misma carpeta. Generado con qwen/qwen3.6-35b-a3b, cada pregunta validada con parse+lint+compile+generate real de packages/vblang antes de guardarse (revisión pedagógica/semántica manual pendiente).
...
variables:
  definicion_correcta: "plantilla"

respuesta: "plantilla"
tipo: completar

enunciado: "El patronaje consiste en crear una {definicion_correcta}, generalmente de papel o cartulina, que representa las piezas planas del diseño final."
...
variables:
  hilo_longitudinal: "urdimbre"

respuesta: "urdimbre"
tipo: completar

enunciado: "Para lograr resultados profesionales, es esencial colocar los patrones sobre el tejido siguiendo la dirección de la {hilo_longitudinal} (el hilo longitudinal) y la trama."
...
variables:
  herramienta: "alfileres"

respuesta: "alfileres"
tipo: completar

enunciado: "Se recomienda fijar los patrones con {herramienta} de cabeza grande o pesas especiales para evitar que se muevan durante el corte."
...
enunciado: "Las costuras son las {funcion} que dan forma y resistencia a la prenda."
...
enunciado: "La costura {tipo_costura} es la base de todo ensamble y consiste en unir dos piezas de tela por sus bordes con una línea de puntadas continua."
...
variables:
  primeras_costuras: "hombros"

respuesta: "hombros"
tipo: completar

enunciado: "Por lo general, se comienza por las costuras principales, como los {primeras_costuras} y los laterales, para dar volumen a la prenda."
...
enunciado: "Es importante {accion} cada costura inmediatamente después de coserla para darle un aspecto limpio y profesional."
...
explicacion: |
  Algunos acabados no solo son funcionales sino también estéticos. Las costinas decorativas, por ejemplo, son visibles y contribuyen al estilo de la prenda.
```
...
explicacion: |
  Aunque la estructura interna sea fuerte, si los acabados (dobladillos, costas visibles, etc.) son pobres, la prenda se percibirá como de baja calidad.
```
