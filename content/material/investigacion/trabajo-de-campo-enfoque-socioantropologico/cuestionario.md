# Investigacion — trabajo de campo enfoque socioantropologico (cuestionario, 23 preguntas VBLang)

> Tema: `investigacion/trabajo-de-campo-enfoque-socioantropologico`. Ver `teoria.md` en esta misma carpeta.
