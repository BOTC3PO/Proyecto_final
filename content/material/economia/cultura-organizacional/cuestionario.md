# Economía — Cultura organizacional (cuestionario, 22 preguntas VBLang)

> Tema: `economia/cultura-organizacional`. Ver `teoria.md` en esta misma carpeta. Escrito a mano (Claude), cada pregunta validada con parse+lint+compile+generate real de packages/vblang antes de guardarse (revisión pedagógica/semántica manual pendiente).
