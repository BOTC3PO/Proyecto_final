...
> Tema del MAPA: `electronica/microcontroladores-y-microprocesadores`. Depende de: a determinar (ver dependencias.md).
...
Este tema se relaciona directamente con sensores y actuadores, donde se explicará cómo los microcontroladores interactúan con componentes externos para controlar sistemas físicos.