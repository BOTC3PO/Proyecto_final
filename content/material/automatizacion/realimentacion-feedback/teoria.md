...
> Tema del MAPA: `automatizacion/realimentacion-feedback`. Depende de: a determinar (ver dependencias.md).
...
Este tema sienta las bases para entender cómo se diseñan sistemas de control más avanzados, como los reguladores PID o los algoritmos de control adaptativo, desarrollados en control pid.