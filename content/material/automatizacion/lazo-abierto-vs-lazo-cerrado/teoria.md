...
> Tema del MAPA: `automatizacion/lazo-abierto-vs-lazo-cerrado`. Depende de: a determinar (ver dependencias.md).
...
Este tema es clave para entender conceptos posteriores como los **controladores PID** y la **integración de sensores**, que dependen del funcionamiento de sistemas de lazo cerrado: controladores pid.