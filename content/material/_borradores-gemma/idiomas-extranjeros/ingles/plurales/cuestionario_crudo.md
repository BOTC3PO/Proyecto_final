...
### 2 — Plurals of Irregular Nouns
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["irregular", "child"]
pasos:
...
### 3 — Uncountable Nouns in Context
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "advice"]
pasos:
...
### 5 — Plural of a Living Thing (Irregular)
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["irregular", "mouse"]
pasos:
  - "Escribe la forma plural del sustantivo."
...
### 6 — Uncountable Nouns in Recipes
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "flour"]
pasos:
  - "Completa la oración con el sustantivo correcto."
...
### 8 — Irregular Plural with Different Root
```
metadata:
  materia: "ingles"
  tema: "plurales"
...
### 9 — Uncountable Nouns in Daily Life
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "information"]
pasos:
  - "Completa la oración con el sustantivo correcto."
...
### 10 — Regular Plural with -s (Animals)
```
metadata:
  materia: "ingles"
  tema: "plurales"
...
### 11 — Irregular Plural with Same Root (Same Spelling)
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["irregular", "sheep"]
pasos:
  - "Escribe la forma plural del sustantivo."
...
### 12 — Uncountable Nouns in Education
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "knowledge"]
pasos:
  - "Completa la oración con el sustantivo correcto."
...
### 13 — Regular Plural with -es (Ending in -ch)
```
metadata:
  materia: "ingles"
  tema: "plurales"
...
### 14 — Irregular Plural with Different Root (Same Spelling)
```
metadata:
  materia: "ingles"
  tema: "plurales"
...
### 15 — Uncountable Nouns in Nature
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "water"]
pasos:
  - "Completa la oración con el sustantivo correcto."
...
### 16 — Regular Plural with -s (Professions)
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["regular", "teacher"]
pasos:
  - "Escribe la forma plural del sustantivo."
...
### 17 — Irregular Plural with Different Root (Same Spelling)
```
metadata:
  materia: "ingles"
  tema: "plurales"
...
### 18 — Uncountable Nouns in Cooking
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "sugar"]
pasos:
  - "Completa la oración con el sustantivo correcto."
...
### 19 — Regular Plural with -es (Ending in -x)
```
metadata:
  materia: "ingles"
  tema: "plurales"
...
### 20 — Irregular Plural with Different Root (Same Spelling)
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["irregular", "tooth"]
pasos:
  - "Escribe la forma plural del sustantivo."
...
### 21 — Uncountable Nouns in Technology
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "software"]
pasos:
  - "Completa la oración con el sustantivo correcto."
...
### 22 — Regular Plural with -s (Everyday Objects)
```
metadata:
  materia: "ingles"
  tema: "plurales"
...
### 23 — Irregular Plural with Different Root (Same Spelling)
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["irregular", "person"]
pasos:
  - "Escribe la forma plural del sustantivo."
...
### 24 — Uncountable Nouns in Health
```
metadata:
  materia: "ingles"
  tema: "plurales"
  nivel: "A1"
  tags: ["incontables", "health"]
pasos:
  - "Completa la oración con el sustantivo correcto."
...
### 25 — Regular Plural with -s (Furniture)
```
metadata:
  materia: "ingles"
  tema: "plurales"
