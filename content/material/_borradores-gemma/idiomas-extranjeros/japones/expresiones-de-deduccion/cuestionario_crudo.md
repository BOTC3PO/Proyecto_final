...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "La expresión '～もの' indica una deducción basada en evidencia clara, como una observación o hecho. En este caso, se infiere que la comida es buena por su apariencia o sabor."
```
...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "'～もの' se usa para conectar un hecho con su consecuencia inevitable. Aquí, la curación de la enfermedad lleva a una deducción natural sobre el estado del paciente."
```
...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "'～もの' se usa para conectar un hecho con una deducción inevitable. Aquí, el colapso de la estructura implica una conclusión lógica sobre su estado previo."
```
...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "'～もの' se usa cuando hay una deducción clara basada en observaciones. En este caso, el mal tiempo lleva a una conclusión inevitable sobre la actividad planificada."
```
...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "'～もの' conecta un hecho con su efecto lógico. Aquí, el cese de la música lleva a una deducción sobre la causa (ej.: apagón)."
```
...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "'～もの' conecta un hecho con su consecuencia natural. Aquí, el descubrimiento del tesoro lleva a una deducción sobre su valor o historia."
```
...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "'～もの' conecta un hecho con una deducción inevitable. Aquí, el daño al equipo lleva a una conclusión lógica sobre su uso excesivo o mal manejo."
```
...
respuestas_validas:
    - "もの"
    - "モノ"
explicacion: "'～もの' se usa para conectar un hecho con su consecuencia inevitable. Aquí, el cese del automóvil lleva a una deducción sobre la causa (ej.: combustible o fallo mecánico)."
```
