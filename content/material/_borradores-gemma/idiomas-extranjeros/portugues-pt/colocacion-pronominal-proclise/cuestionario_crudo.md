...
### 5 — Proclise en infinitivo con "dever"  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "colocacion-pronominal-proclise"  
  nivel: "A2"  
  tags: ["proclise", "infinitivo", "dever"]  
pasos:  
...
### 9 — Proclise con "fazer" y preposición "com"  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "colocacion-pronominal-proclise"  
  nivel: "A1"  
  tags: ["proclise", "preposicao", "fazer"]  
pasos:  
...
### 11 — Proclise con "trazer" y preposición "para"  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "colocacion-pronominal-proclise"  
  nivel: "A1"  
  tags: ["proclise", "preposicao", "trazer"]  
pasos:  
...
### 13 — Proclise con "enviar" y preposición "para"  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "colocacion-pronominal-proclise"  
  nivel: "A1"  
  tags: ["proclise", "preposicao", "enviar"]  
pasos:  
  - "Reconocer la preposición 'para' en el contexto."  
  - "Aplicar la regla de proclisis con esta preposición."  
respuesta: "te"  
...
### 17 — Proclise con "dizer" y preposición "para"  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "colocacion-pronominal-proclise"  
  nivel: "A1"  
  tags: ["proclise", "preposicao", "dizer"]  
pasos:  
  - "Reconocer la preposición 'para' en el contexto."  
  - "Aplicar la regla de proclisis con esta preposición."  
respuesta: "te"  
...
### 19 — Proclise con "trabalhar" y preposición "com"  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "colocacion-pronominal-proclise"  
  nivel: "A1"  
  tags: ["proclise", "preposicao", "trabalhar"]  
pasos:  
  - "Reconocer la preposición 'com' en el contexto."  
  - "Colocar el pronombre antes del verbo."  
respuesta: "me"  
...
### 24 — Proclise en oración con "esquecer" y infinitivo  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "colocacion-pronominal-proclise"  
  nivel: "A2"  
  tags: ["proclise", "infinitivo", "esquecer"]  
pasos:
```
