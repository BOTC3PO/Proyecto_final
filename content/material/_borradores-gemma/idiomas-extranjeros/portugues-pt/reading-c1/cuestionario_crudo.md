...
### 5 — Concordância do verbo com sujeito composto  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "reading-c1"  
...
pasos:  
  - "Identificar o sujeito composto."  
...
metadata:  
  ...
  tema: "reading-c1"  
  nivel: "C1"  
  tags: ["orações", "causal", "se"]  
pasos:  
  - "Identificar a oração causal."  
...
### 18 — Uso do infinitivo pessoal em orações subordinadas adjetivas  
```
metadata:  
  materia: "idiomas-extranjeros/portugues-pt"  
  tema: "reading-c1"  
  nivel: "C1"  
  tags: ["infinitivo", "subordinação", "adjetiva"]  
pasos:  
