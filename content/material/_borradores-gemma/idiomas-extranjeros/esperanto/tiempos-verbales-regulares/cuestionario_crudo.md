...
metadata:
  ...
  nivel: "basica"
  tags: ["presento", "infinitivo"]
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-as' para el presente de 'mi'."
...
metadata:
  ...
  tema: "tiempos-verbales-regulares"
  nivel: "basica"
  tags: ["futuro", "infinitivo"]
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-os' para el futuro de 'vi'."
...
metadata:
  ...
  tema: "tiempos-verbales-regulares"
  nivel: "basica"
  tags: ["pasivo", "infinitivo"]
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-is' para el pasivo simple de 'li'."
...
### 4 — Presente con sujeto plural  
```yaml
metadata:
  materia: "idiomas-extranjeros/esperanto"
  tema: "tiempos-verbales-regulares"
  nivel: "basica"
  tags: ["presento", "plural"]
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-as' para el presente de 'ili'."
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-os' para el futuro de 'ili'."
...
### 6 — Pasivo simple con sujeto plural  
```yaml
metadata:
  materia: "idiomas-extranjeros/esperanto"
  tema: "tiempos-verbales-regulares"
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-is' para el pasivo simple de 'ili'."
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-as' para el presente de 'vi'."
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-os' para el futuro de 'li'."
...
### 9 — Pasivo simple con sujeto 'li'  
```
metadata:  
  materia: "esperanto"  
  tema: "tiempos-verbales-regulares"  
  nivel: "Básica"  
  tags: ["verbo-transitivo", "sujeto-singular"]  
pasos:  
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-as' para el presente de 'ella'."
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-os' para el futuro de 'ella'."
...
### 12 — Pasivo simple con sujeto 'ella'  
```
metadata:  
  materia: "esperanto"  
  tema: "tiempos-verbales-regulares"  
  nivel: "Básica"  
  tags: ["verbo-intransitivo", "sujeto-plural"]  
pasos:  
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-os' para el futuro de 'mi'."
...
### 15 — Pasivo simple con sujeto 'mi'  
```
metadata:  
  materia: "esperanto"  
  tema: "tiempos-verbales-regulares"  
...
### 16 — Presente con sujeto 'ili'  
```
metadata:  
  materia: "esperanto"  
  tema: "tiempos-verbales-regulares"  
  nivel: "Básica"  
  tags: ["verbo-intransitivo", "sujeto-singular"]  
pasos:  
...
### 18 — Pasivo simple con sujeto 'ili'  
```
metadata:  
  materia: "esperanto"  
  tema: "tiempos-verbales-regulares"  
  nivel: "Básica"  
  tags: ["verbo-transitivo", "sujeto-plural"]  
pasos:  
...
### 21 — Pasivo simple con sujeto 'vi'  
```
metadata:  
  materia: "esperanto"  
  tema: "tiempos-verbales-regulares"  
...
pasos:
  - "Identificar la raíz del verbo."
  - "Añadir el sufijo '-as' para el presente de 'li'."
...
### 24 — Pasivo simple con sujeto 'li'  
```
metadata:  
  materia: "esperanto"  
  tema: "tiempos-verbales-regulares"  
