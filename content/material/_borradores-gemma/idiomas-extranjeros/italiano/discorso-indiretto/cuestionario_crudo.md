...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' (a lui) e l'indiretto 'questo libro' si uniscono in 'glielo', con la chiusura del verbo 'dare'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'questo dolce' si uniscono in 'glielo', con la chiusura del verbo 'dare'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'ciò che so' si uniscono in 'glielo', con la chiusura del verbo 'dire'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'il caffè' si uniscono in 'glielo', con la chiusura del verbo 'prendere'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'aiuto' si uniscono in 'glielo', con la chiusura del verbo 'chiedere'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'un regalo' si uniscono in 'glielo', con la chiusura del verbo 'fare'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'il libro' si uniscono in 'glielo', con la chiusura del verbo 'portare'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'il regalo' si uniscono in 'glielo', con la chiusura del verbo 'dare'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'il cappuccino' si uniscono in 'glielo', con la chiusura del verbo 'prendere'."
```
...
opciones_explicitas:
  ...
  - "mel"
tipo: mc
enunciado: "Giovanni disse: 'Ti chiedo una mano.' → Giovanni disse che ___ chiedeva una mano."
respuesta: "gliela"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'una mano' si uniscono in 'gliela', con la chiusura del verbo 'chiedere'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'un favore' si uniscono in 'glielo', con la chiusura del verbo 'fare'."
```
...
respuesta: "glielo"
explicacion: "Il pronome oggetto diretto 'ti' e l'indiretto 'il dolce' si uniscono in 'glielo', con la chiusura del verbo 'portare'."
```
...
### 21 — Discorso indiretto: espressione con "prendere"  
```yaml
metadata:
  materia: "italiano"
  tema: "discorso-indiretto"
  nivel: "B2"
  tags: ["passato prossimo", "imperfetto"]
pasos:
  - "Identificar la estructura de la oración directa y transformarla al discurso indirecto."
  - "Verificar el cambio de tiempo verbal y el pronombre."
explicacion: En el discurso indirecto, cuando el verbo principal es del passato prossimo (disse), el verbo en la oración subordinada se conjugueba en imperfetto. El pronombre "a te" se transforma en "a lui" porque el sujeto de la oración directa es masculino.
tipo: completar
enunciado: Alessio disse: 'Offro
