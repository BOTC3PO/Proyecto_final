...
### 4 — Uso de Adjetivos Comparativos  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["comparativo", "adjetivo"]  
pasos:  
...
### 5 — Estructura de Oración con Tiempo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
...
### 6 — Uso de Pronombres Reflexivos  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["reflexivo", "pronombre"]  
pasos:  
...
### 7 — Uso de Preposiciones con Acusativo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["preposiciones", "acusativo"]  
pasos:  
...
### 9 — Uso de Adverbios Temporales  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adverbio", "temporal"]  
pasos:  
...
### 10 — Uso de Pronombres Objetivos  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["objeto", "pronombre"]  
pasos:  
...
### 11 — Uso de Verbos de Movimiento  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
...
### 12 — Uso de Preposiciones con Dativo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
...
### 13 — Uso de Adjetivos en Dativo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adjetivo", "dativo"]  
pasos:  
...
### 16 — Uso de Verbos con Infinitivo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["verbo", "infinitivo"]  
pasos:  
...
### 17 — Uso de Adjetivos en Acusativo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adjetivo", "acusativo"]  
pasos:  
...
### 18 — Uso de Verbos con Preposiciones  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["verbo", "preposición"]  
pasos:  
...
### 19 — Uso de Pronombres Posesivos  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["posesivo", "pronombre"]  
pasos:  
...
### 20 — Uso de Adverbios de Tiempo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adverbio", "tiempo"]  
pasos:  
...
### 21 — Uso de Verbos con Participle Pasado  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["verbo", "participio"]  
pasos:  
...
### 22 — Uso de Adjetivos en Ablativo  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
  nivel: "A2"  
  tags: ["adjetivo", "ablative"]  
pasos:  
...
### 23 — Uso de Verbos con Infinitivo en Oraciones Subordinadas  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
...
### 24 — Uso de Pronombres Reflexivos en Oraciones Completas  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
...
### 25 — Uso de Adverbios de Lugar en Oraciones Complejas  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "listening-a2"  
