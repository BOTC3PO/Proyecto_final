### 1 — Konjugation von "haben"  
```yaml
metadata:
  materia: "idiomas-extranjeros/aleman"
  tema: "conjugacion-presente"
  nivel: "A1"
  tags: ["haben", "ich"]
pasos:
