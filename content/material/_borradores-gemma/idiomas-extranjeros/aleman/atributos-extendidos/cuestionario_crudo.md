### 1 — Adjektivform mit "der"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["adjektiv", "nominativo"]  
pasos:  
...
### 2 — Adjektivform con "kein"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["adjektiv", "negación"]  
pasos:  
...
### 3 — Adjektivform con "eine"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["adjektiv", "acusativo"]  
pasos:  
...
### 4 — Adjektivform con "jeder"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["adjektiv", "dativo"]  
pasos:  
  - "Identificar el caso y género del sustantivo."  
...
### 5 — Adjektivform con "der" y "daran"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["adjektiv", "preposicional"]  
pasos:  
...
### 7 — Adjektivform con "ein" y "aus dem"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
...
### 8 — Adjektivform con "der" y "während"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
...
### 10 — Adjektivform con "kein" y "ohne"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
...
### 11 — Adjektivform con "ein" y "durch"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
...
### 13 — Adjektivform con "keine" y "wegen"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
...
### 14 — Adjektivform con "ein" y "gegen"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
...
### 15 — Adjektivform con "der" y "ohne"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["adjetivos", "múltiples"]  
pasos:  
  - Identificar el género del sustantivo.  
  - Aplicar la forma correcta del adjetivo según el artículo definido.  
respuesta: "erste"  
respuestas_validas:  
  - "erste"  
  - "Erster"  
...
```  
enunciado: "Ein ___ Tag im Leben."  
tipo: completar  
explicacion: El adjetivo "erster" debe adaptarse al sustantivo neutro "Tag", usando la forma "erste" en este contexto.  
```  

---
```

### 16 — Adjektivform con "kein" y "während"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["artículos", "adjetivos"]  
pasos:  
  - Determinar el género del sustantivo.  
  - Seleccionar la forma correcta del adjetivo con el artículo definido.  
respuesta: "das große Auto"  
opciones_explicitas:  
  - "der große Auto"  
  - "die große Auto"  
  - "das große Auto"  
...
```  
enunciado: "Mit ___ fahre ich zur Arbeit."  
tipo: mc  
explicacion: El sustantivo "Auto" es neutro, por lo que el adjetivo debe ser "großes", pero con el artículo definido "das" se usa "große".  
```  

---
```

### 17 — Adjektivform con "jeder" y "aus dem"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["relativos", "adjetivos"]  
pasos:  
  - Identificar el sustantivo que modifica.  
  - Ajustar el adjetivo según el relativo y el género.  
respuesta: "seine letzte Reise"  
respuestas_validas:  
  - "seine letzte Reise"  
  - "seinen letzten Reise"  

```  
enunciado: "Er spricht über ___ nach Spanien."  
tipo: completar  
explicacion: El adjetivo "letzte" se adapta al sustantivo femenino "Reise", usando la forma "letzte".  
```  

---
```

### 18 — Adjektivform con "keine" y "wegen"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
  ...
  tags: ["artículos", "adjetivos"]  
pasos:  
  - Seleccionar el artículo indefinido adecuado.  
  - Ajustar el adjetivo al género del sustantivo.  
respuesta: "ein altes Haus"  
opciones_explicitas:  
  - "ein alte Haus"  
  - "ein altes Haus"  
  - "eine alte Haus"  
...
```  
enunciado: "Er wohnt in ___ mit einem Garten."  
tipo: mc  
explicacion: El sustantivo "Haus" es masculino, por lo que el adjetivo debe ser "altes" con el artículo indefinido "ein".  
```  

---
```

### 19 — Adjektivform con "ein" y "durch"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
  nivel: "B2"  
  tags: ["posesivos", "adjetivos"]  
pasos:  
  - Identificar el posesivo.  
  - Adaptar el adjetivo al género del sustantivo.  
respuesta: "ihre erste Arbeit"  
respuestas_validas:  
  - "ihre erste Arbeit"  
  - "ihrer erste Arbeit"  

```  
enunciado: "Sie hat ___ in Paris angenommen."  
tipo: completar  
explicacion: El adjetivo "erste" se adapta al sustantivo femenino "Arbeit", usando la forma "erste".  
```  

---
```

### 20 — Adjektivform con "der" y "mit"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
...
pasos:  
  - Determinar el género del sustantivo.  
  - Aplicar la forma correcta del adjetivo con "das".  
respuesta: "das kleine Dorf"  
opciones_explicitas:  
  - "die kleine Dorf"  
  - "das kleine Dorf"  
  - "das kleines Dorf"  
...
```  
enunciado: "Wir besuchen ___ am See."  
tipo: mc  
explicacion: El sustantivo "Dorf" es masculino, por lo que el adjetivo debe ser "kleine" con "das".  
```  

---
```

### 21 — Adjektivform con "kein" y "während"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
...
pasos:  
  - Identificar el género del sustantivo.  
  - Ajustar el adjetivo según el artículo definido.  
respuesta: "der neue Chef"  
opciones_explicitas:  
  - "die neue Chef"  
  - "der neue Chef"  
  - "der neues Chef"  
...
```  
enunciado: "Der ___ gestern angekommen ist."  
tipo: mc  
explicacion: El sustantivo "Chef" es masculino, por lo que el adjetivo debe ser "neue".  
```  

---
```

### 22 — Adjektivform con "jeder" y "aus dem"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
...
```  
enunciado: "Sie trägt ___ die sie gestern kaufte."  
tipo: mc  
explicacion: El sustantivo "Jacke" es femenino, por lo que el adjetivo debe ser "rote".  
```  

---
```

### 23 — Adjektivform con "keine" y "wegen"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
...
pasos:  
  - Identificar el posesivo.  
  - Adaptar el adjetivo al género y número del sustantivo.  
respuesta: "ihre ersten Bücher"  
respuestas_validas:  
  - "ihre ersten Bücher"  
  - "ihrer ersten Bücher"  

```  
enunciado: "Jeder ___ hat seine Bücher dabei."  
tipo: completar  
explicacion: El sustantivo "Schüler" es masculino plural, por lo que el adjetivo debe ser "ersten".  
```  

---
```

### 24 — Adjektivform con "ein" y "durch"  
```
metadata:  
  materia: "alemán"  
  tema: "atributos-extendidos"  
...
pasos:  
  - Identificar el sustantivo que modifica.  
  - Ajustar el adjetivo según el relativo y el género.  
respuesta: "das interessante Buch"  
opciones_explicitas:  
  - "die interessante Buch"  
  - "das interessantes Buch"  
  - "das interessante Buch"  

```  
enunciado: "Das ___ habe ich gelesen."  
tipo: mc  
explicacion: El sustantivo "Buch" es neutro, por lo que el adjetivo debe ser "interessante".  
```
```

### 25 — Adjektivform con "der" y "mit"  
```  
metadata:  
  materia: "idiomas-extranjeros/aleman"  
  tema: "atributos-extendidos"  
