...
> Tema del MAPA: `ofimatica_planilla_de_calculo`. Depende de: a determinar (ver dependencias.md).
...
Este tema es base para entender cómo se construyen **tablas dinámicas**, se aplican **condiciones lógicas** (como SI o Y) y se generan gráficos a partir de los datos procesados en `../ofimatica_graficos/`.