...
> Tema del MAPA: `proceso_programa_en_ejecucion`. Depende de: a determinar (ver dependencias.md).
...
Este tema es la base para entender cómo los sistemas operativos manejan tareas en segundo plano y priorizan procesos, temas desarrollados en `../gestion_de_procesos/`.