...
> Tema del MAPA: `tcp_ip_capas_enrutamiento`. Depende de `../modelo_tcp_ip/` (ver `../dependencias.md`).
...
Este tema es clave para entender el funcionamiento del **enrutamiento dinámico**, abordado en `../enrutamiento_dinamico/`, donde se explicará cómo los routers deciden las rutas óptimas en tiempo real.