...
> Tema del MAPA: `modelo_relacional_conceptos_basicos`. Depende de `../modelo_relacional_conceptos_basicos/` (ver `../dependencias.md`).
...
Este tema forma la base para entender cómo se organizan los datos en una base relacional, lo cual es clave para temas como **normalización de bases de datos** (ver `../normalizacion_basica/`) y el uso de **claves foráneas** (ver `../clave_foranea/`).