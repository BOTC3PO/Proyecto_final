...
> Tema del MAPA: `req_funcionales_no_funcionales`. Depende de: a determinar (ver dependencias.md).
...
Este tema se vincula directamente con el análisis de requisitos y la documentación técnica del software, temas clave para entender cómo se estructura un proyecto en `../ingenieria_software/`.