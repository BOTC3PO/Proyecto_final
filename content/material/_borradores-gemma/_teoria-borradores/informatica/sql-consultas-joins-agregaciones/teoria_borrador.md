...
> Tema del MAPA: `sql_joins_agregaciones`. Depende de `../sql_consultas_basicas/`, `../sql_agregaciones/` y `../sql_joins/` (ver `../dependencias.md`).
...
Este tema conecta con `../sql_subconsultas/` (para usar resultados de una consulta dentro de otra) y con `../sql_joins_avanzados/` (para explorar tipos más complejos como FULL JOIN o SELF JOIN).