...
> Tema del MAPA: `transacciones_acid`. Depende de: a determinar (ver dependencias.md).
...
Este tema es fundamental para entender cómo funcionan los sistemas de gestión de bases de datos en escenarios reales, y servirá como base para temas como `../concurrencia_y_bloqueos/` o `../sistema_de_logs/`.