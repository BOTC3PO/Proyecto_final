...
> Tema del MAPA: `normalizacion_bases_datos`. Depende de: a determinar (ver dependencias.md).
...
Este tema es base para entender el diseño de bases de datos avanzadas, como las que se estudian en `../diseño_bases_datos/` o `../claves_primarias_y_foraneas/`.