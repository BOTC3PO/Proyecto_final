...
> Tema del MAPA: `buses_y_entrada_salida`. Depende de: a determinar (ver dependencias.md).
...
Este tema prepara para entender cómo los dispositivos externos interactúan con el sistema operativo y las aplicaciones, como se explica en `../sistema_operativo_y_dispositivos/`.