...
> Tema del MAPA: `estructuras_de_control_condicionales`. Depende de: a determinar (ver dependencias.md).
...
Este tema es la base para entender estructuras más avanzadas como los bucles condicionales (`while`) o las decisiones anidadas, abordadas en `../estructuras_de_control_repetitivas/`.