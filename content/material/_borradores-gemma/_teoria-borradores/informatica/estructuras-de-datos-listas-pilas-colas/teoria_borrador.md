...
> Tema del MAPA: `estructuras_de_datos_listas_pilas_colas`. Depende de `../introduccion_a_estructuras_de_datos/` (ver `../dependencias.md`).
...
Este tema es el punto de partida para entender estructuras más complejas, como árboles y grafos, que dependen de principios similares a los de pilas, colas o listas. Ver `../estructuras_de_datos_avanzadas/`.