...
> Tema del MAPA: `analisis_estadistico_de_resultados`. Depende de: a determinar (ver dependencias.md).
...
Este tema sirve como base para temas como `../inferencia_estadistica/`, donde se usan estas medidas para hacer predicciones o validar hipótesis en muestras de datos.