...
> Tema del MAPA: `ACCE-03`. Depende de `../accesibilidad_wcag_conceptos/` (ver `../dependencias.md`).
...
Este tema conecta con `../niveles_wcag/` (ver `../dependencias.md`) para entender cómo los requisitos de contraste y semántica se integran dentro de los cuatro niveles de cumplimiento WCAG (A, AA, AAA).