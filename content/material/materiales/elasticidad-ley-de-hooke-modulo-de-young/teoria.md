...
> Tema del MAPA: `materiales/elasticidad-ley-de-hooke-modulo-de-young`. Depende de: a determinar (ver dependencias.md).
...
Este tema forma la base para entender conceptos como la **plasticidad** o el **módulo de corte**, que se exploran en modulo de corte y en análisis de fallos estructurales.