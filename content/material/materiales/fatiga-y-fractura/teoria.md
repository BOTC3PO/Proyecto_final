...
> Tema del MAPA: `materiales/fatiga-y-fractura`. Depende de: a determinar (ver dependencias.md).
...
Este tema está vinculado con los métodos de ensayo de materiales (ver ensayos de materiales) y con el análisis de fallas en estructuras metálicas (ver `../análisis_de_fallas/`).