# Geografia — migraciones internas en argentina (cuestionario, 22 preguntas VBLang)

> Tema: `geografia/migraciones-internas-en-argentina`. Ver `teoria.md` en esta misma carpeta. Generado con qwen/qwen3.6-35b-a3b, cada pregunta validada con parse+lint+compile+generate real de packages/vblang antes de guardarse (revisión pedagógica/semántica manual pendiente).
