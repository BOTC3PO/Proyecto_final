# Informatica — que es la tecnica y la tecnologia (cuestionario, 20 preguntas VBLang)

> Tema: `informatica/que-es-la-tecnica-y-la-tecnologia`. Ver `teoria.md` en esta misma carpeta.
