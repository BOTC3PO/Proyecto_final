...
> Tema del MAPA: `informatica/algoritmo-secuencia-de-pasos`. Depende de: a determinar (ver dependencias.md).
...
Este tema es la base para entender cómo se diseñan **procedimientos programáticos** y **estructuras lógicas**, que se desarrollarán en algoritmos y programacion.