...
> Tema del MAPA: `informatica/patrones-y-buenas-practicas`. Depende de conceptos basicos de programacion (ver `../dependencias.md`).
...
Este tema prepara para entender cómo aplicar patrones específicos (como *MVC* o *Repository*) y profundizar en principios SOLID más allá del SRP, en principios solid.