...
> Tema del MAPA: `informatica/etica-de-la-ia-sesgo-privacidad`. Depende de introduccion a la inteligencia artificial (ver `../dependencias.md`).
...
Este tema prepara para entender cómo se construyen modelos éticos en responsabilidad en la ia y qué normas protegen los derechos digitales en derecho y tecnologia.