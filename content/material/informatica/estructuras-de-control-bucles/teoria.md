...
> Tema del MAPA: `informatica/estructuras-de-control-bucles`. Depende de condiciones y decisiones (ver `../dependencias.md`).
...
Este tema se conecta directamente con manejo de listas, donde los bucles son fundamentales para recorrer y manipular elementos en estructuras como listas, arreglos o diccionarios.