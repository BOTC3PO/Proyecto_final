# Informatica — medios tecnicos extension capacidades humanas (cuestionario, 26 preguntas VBLang)

> Tema: `informatica/medios-tecnicos-extension-capacidades-humanas`. Ver `teoria.md` en esta misma carpeta.
