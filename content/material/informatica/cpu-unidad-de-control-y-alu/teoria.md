...
> Tema del MAPA: `informatica/cpu-unidad-de-control-y-alu`. Depende de: a determinar (ver dependencias.md).
...
Este tema es base para entender cómo se estructuran los programas en niveles bajos (como ensamblador) y cómo interactúa la CPU con otros componentes del computador, como se explica en arquitectura del sistema.