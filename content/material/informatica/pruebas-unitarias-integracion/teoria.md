...
> Tema del MAPA: `informatica/pruebas-unitarias-integracion`. Depende de: a determinar (ver dependencias.md).
...
Este tema sirve como base para entender modelos más avanzados de testing, como las pruebas de aceptación o las automatizadas en entornos de despliegue, explorados en testing automatizado.