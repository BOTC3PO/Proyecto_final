...
> Tema del MAPA: `informatica/planificacion-de-procesos`. Depende de ciclo de vida de un proceso (ver `../dependencias.md`).
...
Este tema es base para entender cómo se gestiona el **uso de recursos en entornos multihilo** (concorrencia y sincronizacion) y cómo los sistemas operativos modernos optimizan la experiencia del usuario.