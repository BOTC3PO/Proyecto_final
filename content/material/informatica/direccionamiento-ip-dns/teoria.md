...
> Tema del MAPA: `informatica/direccionamiento-ip-dns`. Depende de: a determinar (ver dependencias.md).
...
Este tema es fundamental para comprender cómo se estructuran las redes en redes comunicacion y cómo se gestionan los accesos en seguridad redes.