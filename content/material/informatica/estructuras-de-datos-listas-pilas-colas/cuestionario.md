...
variables:
  estructura: uno_de(["Pila", "Cola"])
  principio: uno_de(["LIFO", "FIFO"])
  descripcion: uno_de(["Último en entrar, primero en salir", "Primero en entrar, primero en salir"])

respuesta: estructura
tipo: mc
opciones_explicitas: ["Pila", "Cola"]

enunciado: "Si una estructura de datos sigue el principio de '{descripcion}', estamos ante una ___."
...
variables:
  escenario: uno_de([["push(10)", "push(20)", "push(30)", "pop"], ["push('A')", "push('B')", "push('C')", "pop"], ["push(5)", "push(15)", "push(25)", "pop"]])
...
enunciado: "A diferencia de una pila o una cola, una {lista_tipo} permite el ___ a cualquier elemento mediante su índice sin necesidad de pasar por los anteriores."
