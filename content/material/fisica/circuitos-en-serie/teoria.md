...
> Tema del MAPA: `fisica/circuitos-en-serie`. Depende de conceptos basicos electricidad (ver `../dependencias.md`).
...
Este tema es base para entender cómo se comportan los circuitos en **paralelo** y las combinaciones mixtas de resistencias, desarrolladas en circuitos en paralelo.