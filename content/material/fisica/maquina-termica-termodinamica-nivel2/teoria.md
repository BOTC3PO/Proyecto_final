...
> Tema del MAPA: `fisica/maquina-termica-termodinamica-nivel2`. Depende de termodinamica basico (ver `../dependencias.md`).
...
Este tema se relaciona directamente con el análisis de motores reales (como los de combustión interna o las turbinas) en motores termicos, donde se aplican estos principios para evaluar su rendimiento y limitaciones.