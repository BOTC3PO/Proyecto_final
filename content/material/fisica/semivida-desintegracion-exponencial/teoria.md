...
> Tema del MAPA: `fisica/semivida-desintegracion-exponencial`. Depende de: a determinar (ver dependencias.md).
...
Este tema conecta directamente con el estudio del **modelo matemático de la desintegración** (ver desintegracion modelo matematico), donde se profundizará en las ecuaciones diferenciales que describen este fenómeno.