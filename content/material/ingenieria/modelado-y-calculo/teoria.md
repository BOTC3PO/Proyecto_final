...
> Tema del MAPA: `ingenieria/modelado-y-calculo`. Depende de: a determinar (ver dependencias.md).
...
Este tema sirve como base para entender cómo se construyen modelos más complejos, como los usados en **simulación numérica** (simulacion numerica), donde las ecuaciones derivadas de este proceso se resuelven mediante algoritmos informáticos.