...
> Tema del MAPA: `ingenieria/problema-y-restricciones`. Depende de conceptos basicos (ver `../dependencias.md`).
...
Este tema conecta con analisis de soluciones, donde se evalúan si las propuestas cumplen los requisitos y respetan las restricciones, antes de pasar a la implementación.