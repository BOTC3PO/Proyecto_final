...
-- CreateTable
CREATE TABLE "generator_changelog" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "generator_changelog_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "plazo_fijo" (
    ...
    CONSTRAINT "plazo_fijo_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "fci_posiciones" (
    "id" TEXT NOT NULL,
    "usuario_id" TEXT NOT NULL,
    "aula_id" TEXT,
    "monto" DOUBLE PRECISION NOT NULL,
    "tasa_mensual" DOUBLE PRECISION NOT NULL,
    "dias" INTEGER NOT NULL,
    "interes" DOUBLE PRECISION NOT NULL,
    "total" DOUBLE PRECISION NOT NULL,
    "estado" TEXT NOT NULL DEFAULT 'activo',
    ...
    CONSTRAINT "fci_posiciones_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "tienda_items" (
    ...
    CONSTRAINT "tienda_items_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "usuario_items" (
    ...
    CONSTRAINT "usuario_items_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "quiz_competencia" (
    "id" TEXT NOT NULL,
    "quiz_id" TEXT NOT NULL,
    "modulo_id" TEXT,
    "aula_id" TEXT,
    ...
    CONSTRAINT "quiz_competencia_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "avisos_leidos" (
    ...
    CONSTRAINT "avisos_leidos_pkey" PRIMARY KEY ("aviso_id","usuario_id")
);
...
CREATE TABLE "hilos" (
    ...
    CONSTRAINT "hilos_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "suscripciones" (
    ...
    "monto_mensual" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "limites_escuela" (
    ...
    CONSTRAINT "limites_escuela_pkey" PRIMARY KEY ("escuela_id")
);
...
-- AddForeignKey
ALTER TABLE "generator_changelog" ADD CONSTRAINT "generator_changelog_generator_id_fkey" FOREIGN KEY ("generator_id") REFERENCES "generator_configs"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "usuario_items" ADD CONSTRAINT "usuario_items_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "tienda_items"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "avisos_leidos" ADD CONSTRAINT "avisos_leidos_aviso_id_fkey" FOREIGN KEY ("aviso_id") REFERENCES "avisos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mensajes_directos" ADD CONSTRAINT "mensajes_directos_hilo_id_fkey" FOREIGN KEY ("hilo_id") REFERENCES "hilos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "historial_pagos" ADD CONSTRAINT "historial_pagos_suscripcion_id_fkey" FOREIGN KEY ("suscripcion_id") REFERENCES "suscripciones"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
