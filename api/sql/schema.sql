...
-- This file represents the full DB state after all applied migrations.
-- DO NOT edit this file to make schema changes; add a new migration instead.
--
-- Current version: 1  (matches PRAGMA user_version)
-- Last migration:  0001_init.sql
--
-- To create a fresh DB:   npm run db:sqlite:migrate
-- To inspect version:     sqlite3 $SQLITE_PATH "PRAGMA user_version;"
-- =============================================================================
...
-- Machine-readable version is PRAGMA user_version.
-- =============================================================================
