...
import { revisionEscuela } from "./routes/revision-escuela";
import { verificacionPublica } from "./routes/verificacion-publica";
...
app.use(revisionEscuela);
app.use(verificacionPublica);
app.use(economia);
app.use(aulaFeed);
