> **ARCHIVO HISTÓRICO — NO USAR.** Este README quedó obsoleto: describía un stack
> incorrecto (MongoDB + npm). El proyecto real usa un monorepo **pnpm** con
> **Prisma + PostgreSQL**. Se conserva solo como referencia histórica.
> El README vigente está en la raíz del repositorio (`/README.md`).
